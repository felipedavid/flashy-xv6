...
int main(int argc, char **argv) {
  ...
  1c:	624080e7          	jalr	1572(ra) # 63c <pipe>
  pipe(child2parent);
  20:	fd840793          	addi	a5,s0,-40
  24:	853e                	mv	a0,a5
  26:	00000097          	auipc	ra,0x0
  2a:	616080e7          	jalr	1558(ra) # 63c <pipe>

  char byte = 'A';
  2e:	04100793          	li	a5,65
  32:	fcf40ba3          	sb	a5,-41(s0)

  int pid = fork();
  36:	00000097          	auipc	ra,0x0
  3a:	5ee080e7          	jalr	1518(ra) # 624 <fork>
  3e:	87aa                	mv	a5,a0
  40:	fef42623          	sw	a5,-20(s0)
  if (pid == 0) {
  44:	fec42783          	lw	a5,-20(s0)
  48:	2781                	sext.w	a5,a5
  4a:	e3d1                	bnez	a5,ce <main+0xce>
    close(parent2child[1]);
  4c:	fe442783          	lw	a5,-28(s0)
  50:	853e                	mv	a0,a5
  52:	00000097          	auipc	ra,0x0
  56:	602080e7          	jalr	1538(ra) # 654 <close>
    read(parent2child[0], &byte, 1);
  5a:	fe042783          	lw	a5,-32(s0)
  5e:	fd740713          	addi	a4,s0,-41
  62:	4605                	li	a2,1
  64:	85ba                	mv	a1,a4
  66:	853e                	mv	a0,a5
  68:	00000097          	auipc	ra,0x0
  6c:	5dc080e7          	jalr	1500(ra) # 644 <read>
    close(parent2child[0]);
  70:	fe042783          	lw	a5,-32(s0)
  74:	853e                	mv	a0,a5
  76:	00000097          	auipc	ra,0x0
  7a:	5de080e7          	jalr	1502(ra) # 654 <close>
    printf("%d: received ping\n", getpid()); 
  7e:	00000097          	auipc	ra,0x0
  82:	62e080e7          	jalr	1582(ra) # 6ac <getpid>
  86:	87aa                	mv	a5,a0
  88:	85be                	mv	a1,a5
  8a:	00001517          	auipc	a0,0x1
  8e:	e1650513          	addi	a0,a0,-490 # ea0 <malloc+0x14a>
  92:	00001097          	auipc	ra,0x1
  96:	ad2080e7          	jalr	-1326(ra) # b64 <printf>

    close(child2parent[0]);
  9a:	fd842783          	lw	a5,-40(s0)
  9e:	853e                	mv	a0,a5
  a0:	00000097          	auipc	ra,0x0
  a4:	5b4080e7          	jalr	1460(ra) # 654 <close>
    write(child2parent[1], &byte, 1);
  a8:	fdc42783          	lw	a5,-36(s0)
  ac:	fd740713          	addi	a4,s0,-41
  b0:	4605                	li	a2,1
  b2:	85ba                	mv	a1,a4
  b4:	853e                	mv	a0,a5
  b6:	00000097          	auipc	ra,0x0
  ba:	596080e7          	jalr	1430(ra) # 64c <write>
    close(child2parent[1]);
  be:	fdc42783          	lw	a5,-36(s0)
  c2:	853e                	mv	a0,a5
  c4:	00000097          	auipc	ra,0x0
  c8:	590080e7          	jalr	1424(ra) # 654 <close>
  cc:	a06d                	j	176 <main+0x176>
  } else if (pid > 0) {
  ce:	fec42783          	lw	a5,-20(s0)
  d2:	2781                	sext.w	a5,a5
  d4:	08f05363          	blez	a5,15a <main+0x15a>
    close(parent2child[0]);
  d8:	fe042783          	lw	a5,-32(s0)
  dc:	853e                	mv	a0,a5
  de:	00000097          	auipc	ra,0x0
  e2:	576080e7          	jalr	1398(ra) # 654 <close>
    write(parent2child[1], &byte, 1);
  e6:	fe442783          	lw	a5,-28(s0)
  ea:	fd740713          	addi	a4,s0,-41
  ee:	4605                	li	a2,1
  f0:	85ba                	mv	a1,a4
  f2:	853e                	mv	a0,a5
  f4:	00000097          	auipc	ra,0x0
  f8:	558080e7          	jalr	1368(ra) # 64c <write>
    close(parent2child[1]);
  fc:	fe442783          	lw	a5,-28(s0)
 100:	853e                	mv	a0,a5
 102:	00000097          	auipc	ra,0x0
 106:	552080e7          	jalr	1362(ra) # 654 <close>

    close(child2parent[1]);
 10a:	fdc42783          	lw	a5,-36(s0)
 10e:	853e                	mv	a0,a5
 110:	00000097          	auipc	ra,0x0
 114:	544080e7          	jalr	1348(ra) # 654 <close>
    read(child2parent[0], &byte, 1);
 118:	fd842783          	lw	a5,-40(s0)
 11c:	fd740713          	addi	a4,s0,-41
 120:	4605                	li	a2,1
 122:	85ba                	mv	a1,a4
 124:	853e                	mv	a0,a5
 126:	00000097          	auipc	ra,0x0
 12a:	51e080e7          	jalr	1310(ra) # 644 <read>
    close(child2parent[0]);
 12e:	fd842783          	lw	a5,-40(s0)
 132:	853e                	mv	a0,a5
 134:	00000097          	auipc	ra,0x0
 138:	520080e7          	jalr	1312(ra) # 654 <close>
    printf("%d: received pong\n", getpid());
 13c:	00000097          	auipc	ra,0x0
 140:	570080e7          	jalr	1392(ra) # 6ac <getpid>
 144:	87aa                	mv	a5,a0
 146:	85be                	mv	a1,a5
 148:	00001517          	auipc	a0,0x1
 14c:	d7050513          	addi	a0,a0,-656 # eb8 <malloc+0x162>
 150:	00001097          	auipc	ra,0x1
 154:	a14080e7          	jalr	-1516(ra) # b64 <printf>
 158:	a839                	j	176 <main+0x176>
  } else {
    fprintf(2, "oops, something went wrong!\n");
 15a:	00001597          	auipc	a1,0x1
 15e:	d7658593          	addi	a1,a1,-650 # ed0 <malloc+0x17a>
 162:	4509                	li	a0,2
 164:	00001097          	auipc	ra,0x1
 168:	9a8080e7          	jalr	-1624(ra) # b0c <fprintf>
    exit(-1);
 16c:	557d                	li	a0,-1
 16e:	00000097          	auipc	ra,0x0
 172:	4be080e7          	jalr	1214(ra) # 62c <exit>
  }
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 a20:	4d478793          	addi	a5,a5,1236 # ef0 <malloc+0x19a>
...
free(void *ap)
{
 ...
 bcc:	46878793          	addi	a5,a5,1128 # 1030 <freep>
 bd0:	639c                	ld	a5,0(a5)
...
morecore(uint nu)
{
 ...
 d46:	2ee78793          	addi	a5,a5,750 # 1030 <freep>
 d4a:	639c                	ld	a5,0(a5)
}
 d4c:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
 ...
 d8c:	29878793          	addi	a5,a5,664 # 1020 <base>
 d90:	fef43023          	sd	a5,-32(s0)
 d94:	00000797          	auipc	a5,0x0
 d98:	29c78793          	addi	a5,a5,668 # 1030 <freep>
 d9c:	fe043703          	ld	a4,-32(s0)
 da0:	e398                	sd	a4,0(a5)
 da2:	00000797          	auipc	a5,0x0
 da6:	28e78793          	addi	a5,a5,654 # 1030 <freep>
 daa:	6398                	ld	a4,0(a5)
 dac:	00000797          	auipc	a5,0x0
 db0:	27478793          	addi	a5,a5,628 # 1020 <base>
 db4:	e398                	sd	a4,0(a5)
    base.s.size = 0;
