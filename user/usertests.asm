...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      52:	0d250513          	addi	a0,a0,210 # 8120 <malloc+0x146>
    ...
    if(fd < 0){
      ...
      72:	0ba50513          	addi	a0,a0,186 # 8128 <malloc+0x14e>
      76:	00008097          	auipc	ra,0x8
      7a:	d72080e7          	jalr	-654(ra) # 7de8 <printf>
      exit(1);
      7e:	4505                	li	a0,1
    ...
    if(n >= 0){
      ...
      bc:	08850513          	addi	a0,a0,136 # 8140 <malloc+0x166>
      c0:	00008097          	auipc	ra,0x8
      c4:	d28080e7          	jalr	-728(ra) # 7de8 <printf>
      exit(1);
      c8:	4505                	li	a0,1
    ...
    unlink("copyin1");
      ...
      e4:	04050513          	addi	a0,a0,64 # 8120 <malloc+0x146>
    ...
    if(n > 0){
     ...
     120:	05450513          	addi	a0,a0,84 # 8170 <malloc+0x196>
     124:	00008097          	auipc	ra,0x8
     128:	cc4080e7          	jalr	-828(ra) # 7de8 <printf>
      exit(1);
     12c:	4505                	li	a0,1
    ...
    if(pipe(fds) < 0){
     ...
     14e:	05650513          	addi	a0,a0,86 # 81a0 <malloc+0x1c6>
     152:	00008097          	auipc	ra,0x8
     156:	c96080e7          	jalr	-874(ra) # 7de8 <printf>
      exit(1);
     15a:	4505                	li	a0,1
    ...
    if(n > 0){
     ...
     198:	01c50513          	addi	a0,a0,28 # 81b0 <malloc+0x1d6>
     19c:	00008097          	auipc	ra,0x8
     1a0:	c4c080e7          	jalr	-948(ra) # 7de8 <printf>
      exit(1);
     1a4:	4505                	li	a0,1
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     226:	fbe50513          	addi	a0,a0,-66 # 81e0 <malloc+0x206>
    ...
    if(fd < 0){
     ...
     246:	fa650513          	addi	a0,a0,-90 # 81e8 <malloc+0x20e>
     24a:	00008097          	auipc	ra,0x8
     24e:	b9e080e7          	jalr	-1122(ra) # 7de8 <printf>
      exit(1);
     252:	4505                	li	a0,1
    ...
    if(n > 0){
     ...
     290:	f7450513          	addi	a0,a0,-140 # 8200 <malloc+0x226>
     294:	00008097          	auipc	ra,0x8
     298:	b54080e7          	jalr	-1196(ra) # 7de8 <printf>
      exit(1);
     29c:	4505                	li	a0,1
    ...
    if(pipe(fds) < 0){
     ...
     2cc:	ed850513          	addi	a0,a0,-296 # 81a0 <malloc+0x1c6>
     2d0:	00008097          	auipc	ra,0x8
     2d4:	b18080e7          	jalr	-1256(ra) # 7de8 <printf>
      exit(1);
     2d8:	4505                	li	a0,1
    ...
    n = write(fds[1], "x", 1);
     ...
     2ec:	f4858593          	addi	a1,a1,-184 # 8230 <malloc+0x256>
     2f0:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     312:	f2a50513          	addi	a0,a0,-214 # 8238 <malloc+0x25e>
     316:	00008097          	auipc	ra,0x8
     31a:	ad2080e7          	jalr	-1326(ra) # 7de8 <printf>
      exit(1);
     31e:	4505                	li	a0,1
    ...
    if(n > 0){
     ...
     35c:	ef850513          	addi	a0,a0,-264 # 8250 <malloc+0x276>
     360:	00008097          	auipc	ra,0x8
     364:	a88080e7          	jalr	-1400(ra) # 7de8 <printf>
      exit(1);
     368:	4505                	li	a0,1
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     414:	e7050513          	addi	a0,a0,-400 # 8280 <malloc+0x2a6>
     418:	00008097          	auipc	ra,0x8
     41c:	9d0080e7          	jalr	-1584(ra) # 7de8 <printf>
      exit(1);
     420:	4505                	li	a0,1
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c0:	de450513          	addi	a0,a0,-540 # 82a0 <malloc+0x2c6>
     4c4:	00008097          	auipc	ra,0x8
     4c8:	924080e7          	jalr	-1756(ra) # 7de8 <printf>
    exit(1);
     4cc:	4505                	li	a0,1
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     50c:	db850513          	addi	a0,a0,-584 # 82c0 <malloc+0x2e6>
     510:	00008097          	auipc	ra,0x8
     514:	8d8080e7          	jalr	-1832(ra) # 7de8 <printf>
    exit(1);
     518:	4505                	li	a0,1
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     55e:	d8650513          	addi	a0,a0,-634 # 82e0 <malloc+0x306>
     562:	00008097          	auipc	ra,0x8
     566:	886080e7          	jalr	-1914(ra) # 7de8 <printf>
    exit(1);
     56a:	4505                	li	a0,1
  ...
  char *args[] = { "xx", 0 };
     ...
     578:	d9478793          	addi	a5,a5,-620 # 8308 <malloc+0x32e>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5bc:	d5850513          	addi	a0,a0,-680 # 8310 <malloc+0x336>
     5c0:	00008097          	auipc	ra,0x8
     5c4:	828080e7          	jalr	-2008(ra) # 7de8 <printf>
    exit(1);
     5c8:	4505                	li	a0,1
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     ...
     5ee:	d4650513          	addi	a0,a0,-698 # 8330 <malloc+0x356>
     5f2:	00007097          	auipc	ra,0x7
     5f6:	7f6080e7          	jalr	2038(ra) # 7de8 <printf>
    exit(1);
     5fa:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    char *args2[] = { big, big, big, 0 };
     ...
     654:	d5078793          	addi	a5,a5,-688 # 83a0 <malloc+0x3c6>
     658:	6390                	ld	a2,0(a5)
     65a:	6794                	ld	a3,8(a5)
    ...
    ret = exec("echo", args2);
     ...
     67a:	cca50513          	addi	a0,a0,-822 # 8340 <malloc+0x366>
    ...
    if(ret != -1){
     ...
     6a4:	ca850513          	addi	a0,a0,-856 # 8348 <malloc+0x36e>
     6a8:	00007097          	auipc	ra,0x7
     6ac:	740080e7          	jalr	1856(ra) # 7de8 <printf>
      exit(1);
     6b0:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     ...
     6ea:	c8a50513          	addi	a0,a0,-886 # 8370 <malloc+0x396>
     6ee:	00007097          	auipc	ra,0x7
     6f2:	6fa080e7          	jalr	1786(ra) # 7de8 <printf>
    exit(1);
     6f6:	4505                	li	a0,1
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     ...
     780:	c4450513          	addi	a0,a0,-956 # 83c0 <malloc+0x3e6>
     784:	00007097          	auipc	ra,0x7
     788:	664080e7          	jalr	1636(ra) # 7de8 <printf>
    exit(1);
     78c:	4505                	li	a0,1
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7da:	aca50513          	addi	a0,a0,-1334 # 82a0 <malloc+0x2c6>
     7de:	00007097          	auipc	ra,0x7
     7e2:	60a080e7          	jalr	1546(ra) # 7de8 <printf>
    exit(1);
     7e6:	4505                	li	a0,1
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     822:	aa250513          	addi	a0,a0,-1374 # 82c0 <malloc+0x2e6>
     826:	00007097          	auipc	ra,0x7
     82a:	5c2080e7          	jalr	1474(ra) # 7de8 <printf>
    exit(1);
     82e:	4505                	li	a0,1
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     86e:	a7650513          	addi	a0,a0,-1418 # 82e0 <malloc+0x306>
     872:	00007097          	auipc	ra,0x7
     876:	576080e7          	jalr	1398(ra) # 7de8 <printf>
    exit(1);
     87a:	4505                	li	a0,1
  ...
  char *args[] = { "xx", 0 };
     ...
     888:	a8478793          	addi	a5,a5,-1404 # 8308 <malloc+0x32e>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8c8:	a4c50513          	addi	a0,a0,-1460 # 8310 <malloc+0x336>
     8cc:	00007097          	auipc	ra,0x7
     8d0:	51c080e7          	jalr	1308(ra) # 7de8 <printf>
    exit(1);
     8d4:	4505                	li	a0,1
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     ...
     90e:	abe50513          	addi	a0,a0,-1346 # 83c8 <malloc+0x3ee>
     912:	00007097          	auipc	ra,0x7
     916:	4d6080e7          	jalr	1238(ra) # 7de8 <printf>
    exit(1);
     91a:	4505                	li	a0,1
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     ...
     93a:	aaa50513          	addi	a0,a0,-1366 # 83e0 <malloc+0x406>
     93e:	00007097          	auipc	ra,0x7
     942:	4aa080e7          	jalr	1194(ra) # 7de8 <printf>
    exit(1);
     946:	4505                	li	a0,1
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     958:	aac50513          	addi	a0,a0,-1364 # 8400 <malloc+0x426>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     978:	a9450513          	addi	a0,a0,-1388 # 8408 <malloc+0x42e>
     97c:	00007097          	auipc	ra,0x7
     980:	46c080e7          	jalr	1132(ra) # 7de8 <printf>
    exit(1);
     984:	4505                	li	a0,1
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d0:	a5450513          	addi	a0,a0,-1452 # 8420 <malloc+0x446>
     9d4:	00007097          	auipc	ra,0x7
     9d8:	414080e7          	jalr	1044(ra) # 7de8 <printf>
    exit(1);
     9dc:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
     ...
     9f8:	a0c50513          	addi	a0,a0,-1524 # 8400 <malloc+0x426>
  ...
  fd = open("README", O_RDONLY);
     ...
     a0a:	7da50513          	addi	a0,a0,2010 # 81e0 <malloc+0x206>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a2a:	9e250513          	addi	a0,a0,-1566 # 8408 <malloc+0x42e>
     a2e:	00007097          	auipc	ra,0x7
     a32:	3ba080e7          	jalr	954(ra) # 7de8 <printf>
    exit(1);
     a36:	4505                	li	a0,1
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a80:	9d450513          	addi	a0,a0,-1580 # 8450 <malloc+0x476>
     a84:	00007097          	auipc	ra,0x7
     a88:	364080e7          	jalr	868(ra) # 7de8 <printf>
    exit(1);
     a8c:	4505                	li	a0,1
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     aee:	99e58593          	addi	a1,a1,-1634 # 8488 <malloc+0x4ae>
     af2:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b10:	96c50513          	addi	a0,a0,-1684 # 8478 <malloc+0x49e>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b5c:	93850513          	addi	a0,a0,-1736 # 8490 <malloc+0x4b6>
     b60:	00007097          	auipc	ra,0x7
     b64:	288080e7          	jalr	648(ra) # 7de8 <printf>
    exit(1);
     b68:	4505                	li	a0,1
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b7a:	90250513          	addi	a0,a0,-1790 # 8478 <malloc+0x49e>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b92:	8ea50513          	addi	a0,a0,-1814 # 8478 <malloc+0x49e>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bd4:	8e050513          	addi	a0,a0,-1824 # 84b0 <malloc+0x4d6>
     bd8:	00007097          	auipc	ra,0x7
     bdc:	210080e7          	jalr	528(ra) # 7de8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     be0:	fe442783          	lw	a5,-28(s0)
     be4:	863e                	mv	a2,a5
     be6:	fb843583          	ld	a1,-72(s0)
     bea:	00008517          	auipc	a0,0x8
     bee:	8d650513          	addi	a0,a0,-1834 # 84c0 <malloc+0x4e6>
     bf2:	00007097          	auipc	ra,0x7
     bf6:	1f6080e7          	jalr	502(ra) # 7de8 <printf>
    exit(1);
     bfa:	4505                	li	a0,1
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c34:	8b050513          	addi	a0,a0,-1872 # 84e0 <malloc+0x506>
     c38:	00007097          	auipc	ra,0x7
     c3c:	1b0080e7          	jalr	432(ra) # 7de8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     c40:	fe442783          	lw	a5,-28(s0)
     c44:	863e                	mv	a2,a5
     c46:	fb843583          	ld	a1,-72(s0)
     c4a:	00008517          	auipc	a0,0x8
     c4e:	87650513          	addi	a0,a0,-1930 # 84c0 <malloc+0x4e6>
     c52:	00007097          	auipc	ra,0x7
     c56:	196080e7          	jalr	406(ra) # 7de8 <printf>
    exit(1);
     c5a:	4505                	li	a0,1
  ...
  write(fd1, "abcdef", 6);
     ...
     c6e:	88658593          	addi	a1,a1,-1914 # 84f0 <malloc+0x516>
     c72:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cb6:	84650513          	addi	a0,a0,-1978 # 84f8 <malloc+0x51e>
     cba:	00007097          	auipc	ra,0x7
     cbe:	12e080e7          	jalr	302(ra) # 7de8 <printf>
    exit(1);
     cc2:	4505                	li	a0,1
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d06:	81650513          	addi	a0,a0,-2026 # 8518 <malloc+0x53e>
     d0a:	00007097          	auipc	ra,0x7
     d0e:	0de080e7          	jalr	222(ra) # 7de8 <printf>
    exit(1);
     d12:	4505                	li	a0,1
  ...
  unlink("truncfile");
     ...
     d20:	75c50513          	addi	a0,a0,1884 # 8478 <malloc+0x49e>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d70:	70c50513          	addi	a0,a0,1804 # 8478 <malloc+0x49e>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d84:	6f850513          	addi	a0,a0,1784 # 8478 <malloc+0x49e>
  ...
  write(fd1, "abcd", 4);
     ...
     da0:	6ec58593          	addi	a1,a1,1772 # 8488 <malloc+0x4ae>
     da4:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     db6:	6c650513          	addi	a0,a0,1734 # 8478 <malloc+0x49e>
  ...
  int n = write(fd1, "x", 1);
     ...
     dd2:	46258593          	addi	a1,a1,1122 # 8230 <malloc+0x256>
     dd6:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e02:	73a50513          	addi	a0,a0,1850 # 8538 <malloc+0x55e>
     e06:	00007097          	auipc	ra,0x7
     e0a:	fe2080e7          	jalr	-30(ra) # 7de8 <printf>
    exit(1);
     e0e:	4505                	li	a0,1
  ...
  unlink("truncfile");
     ...
     e1c:	66050513          	addi	a0,a0,1632 # 8478 <malloc+0x49e>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e62:	61a50513          	addi	a0,a0,1562 # 8478 <malloc+0x49e>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     e9a:	6ca50513          	addi	a0,a0,1738 # 8560 <malloc+0x586>
     e9e:	00007097          	auipc	ra,0x7
     ea2:	f4a080e7          	jalr	-182(ra) # 7de8 <printf>
    exit(1);
     ea6:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ec6:	5b650513          	addi	a0,a0,1462 # 8478 <malloc+0x49e>
     ...
     eea:	69250513          	addi	a0,a0,1682 # 8578 <malloc+0x59e>
     eee:	00007097          	auipc	ra,0x7
     ef2:	efa080e7          	jalr	-262(ra) # 7de8 <printf>
        exit(1);
     ef6:	4505                	li	a0,1
     ...
     f0a:	68a58593          	addi	a1,a1,1674 # 8590 <malloc+0x5b6>
     f0e:	853e                	mv	a0,a5
     ...
     f3a:	66a50513          	addi	a0,a0,1642 # 85a0 <malloc+0x5c6>
     f3e:	00007097          	auipc	ra,0x7
     f42:	eaa080e7          	jalr	-342(ra) # 7de8 <printf>
        exit(1);
     f46:	4505                	li	a0,1
     ...
     f64:	51850513          	addi	a0,a0,1304 # 8478 <malloc+0x49e>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fce:	4ae50513          	addi	a0,a0,1198 # 8478 <malloc+0x49e>
    ...
    if(fd < 0){
     ...
     ff2:	58a50513          	addi	a0,a0,1418 # 8578 <malloc+0x59e>
     ff6:	00007097          	auipc	ra,0x7
     ffa:	df2080e7          	jalr	-526(ra) # 7de8 <printf>
      exit(1);
     ffe:	4505                	li	a0,1
    ...
    1012:	5b258593          	addi	a1,a1,1458 # 85c0 <malloc+0x5e6>
    1016:	853e                	mv	a0,a5
    ...
    1042:	58a50513          	addi	a0,a0,1418 # 85c8 <malloc+0x5ee>
    1046:	00007097          	auipc	ra,0x7
    104a:	da2080e7          	jalr	-606(ra) # 7de8 <printf>
      exit(1);
    104e:	4505                	li	a0,1
  ...
  unlink("truncfile");
    ...
    1092:	3ea50513          	addi	a0,a0,1002 # 8478 <malloc+0x49e>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10bc:	53050513          	addi	a0,a0,1328 # 85e8 <malloc+0x60e>
    ...
    10d6:	51e50513          	addi	a0,a0,1310 # 85f0 <malloc+0x616>
    10da:	00007097          	auipc	ra,0x7
    10de:	d0e080e7          	jalr	-754(ra) # 7de8 <printf>
    exit(1);
    10e2:	4505                	li	a0,1
  ...
  if(chdir("iputdir") < 0){
    ...
    10f0:	4fc50513          	addi	a0,a0,1276 # 85e8 <malloc+0x60e>
    ...
    110a:	50250513          	addi	a0,a0,1282 # 8608 <malloc+0x62e>
    110e:	00007097          	auipc	ra,0x7
    1112:	cda080e7          	jalr	-806(ra) # 7de8 <printf>
    exit(1);
    1116:	4505                	li	a0,1
  ...
  if(unlink("../iputdir") < 0){
    ...
    1124:	50850513          	addi	a0,a0,1288 # 8628 <malloc+0x64e>
    ...
    113e:	4fe50513          	addi	a0,a0,1278 # 8638 <malloc+0x65e>
    1142:	00007097          	auipc	ra,0x7
    1146:	ca6080e7          	jalr	-858(ra) # 7de8 <printf>
    exit(1);
    114a:	4505                	li	a0,1
  ...
  if(chdir("/") < 0){
    ...
    1158:	50450513          	addi	a0,a0,1284 # 8658 <malloc+0x67e>
    ...
    1172:	4f250513          	addi	a0,a0,1266 # 8660 <malloc+0x686>
    1176:	00007097          	auipc	ra,0x7
    117a:	c72080e7          	jalr	-910(ra) # 7de8 <printf>
    exit(1);
    117e:	4505                	li	a0,1
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11be:	3a650513          	addi	a0,a0,934 # 8560 <malloc+0x586>
    11c2:	00007097          	auipc	ra,0x7
    11c6:	c26080e7          	jalr	-986(ra) # 7de8 <printf>
    exit(1);
    11ca:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    11e0:	40c50513          	addi	a0,a0,1036 # 85e8 <malloc+0x60e>
    ...
    11fa:	3fa50513          	addi	a0,a0,1018 # 85f0 <malloc+0x616>
    11fe:	00007097          	auipc	ra,0x7
    1202:	bea080e7          	jalr	-1046(ra) # 7de8 <printf>
      exit(1);
    1206:	4505                	li	a0,1
    ...
    1214:	3d850513          	addi	a0,a0,984 # 85e8 <malloc+0x60e>
    ...
    122e:	44e50513          	addi	a0,a0,1102 # 8678 <malloc+0x69e>
    1232:	00007097          	auipc	ra,0x7
    1236:	bb6080e7          	jalr	-1098(ra) # 7de8 <printf>
      exit(1);
    123a:	4505                	li	a0,1
    ...
    1248:	3e450513          	addi	a0,a0,996 # 8628 <malloc+0x64e>
    ...
    1262:	3da50513          	addi	a0,a0,986 # 8638 <malloc+0x65e>
    1266:	00007097          	auipc	ra,0x7
    126a:	b82080e7          	jalr	-1150(ra) # 7de8 <printf>
      exit(1);
    126e:	4505                	li	a0,1
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12ae:	3e650513          	addi	a0,a0,998 # 8690 <malloc+0x6b6>
    ...
    12c8:	3d450513          	addi	a0,a0,980 # 8698 <malloc+0x6be>
    12cc:	00007097          	auipc	ra,0x7
    12d0:	b1c080e7          	jalr	-1252(ra) # 7de8 <printf>
    exit(1);
    12d4:	4505                	li	a0,1
  ...
  if(pid < 0){
    ...
    12fe:	26650513          	addi	a0,a0,614 # 8560 <malloc+0x586>
    1302:	00007097          	auipc	ra,0x7
    1306:	ae6080e7          	jalr	-1306(ra) # 7de8 <printf>
    exit(1);
    130a:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    1322:	37250513          	addi	a0,a0,882 # 8690 <malloc+0x6b6>
    ...
    1346:	36e50513          	addi	a0,a0,878 # 86b0 <malloc+0x6d6>
    134a:	00007097          	auipc	ra,0x7
    134e:	a9e080e7          	jalr	-1378(ra) # 7de8 <printf>
      exit(1);
    1352:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    1374:	32050513          	addi	a0,a0,800 # 8690 <malloc+0x6b6>
    ...
    138c:	35050513          	addi	a0,a0,848 # 86d8 <malloc+0x6fe>
    1390:	00007097          	auipc	ra,0x7
    1394:	a58080e7          	jalr	-1448(ra) # 7de8 <printf>
    exit(1);
    1398:	4505                	li	a0,1
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    ...
    13d0:	f7450513          	addi	a0,a0,-140 # 8340 <malloc+0x366>
  ...
  if(fd < 0){
    ...
    13f4:	30050513          	addi	a0,a0,768 # 86f0 <malloc+0x716>
    13f8:	00007097          	auipc	ra,0x7
    13fc:	9f0080e7          	jalr	-1552(ra) # 7de8 <printf>
    exit(1);
    1400:	4505                	li	a0,1
  ...
  fd = open("doesnotexist", 0);
    ...
    141e:	2ee50513          	addi	a0,a0,750 # 8708 <malloc+0x72e>
  ...
  if(fd >= 0){
    ...
    1442:	2da50513          	addi	a0,a0,730 # 8718 <malloc+0x73e>
    1446:	00007097          	auipc	ra,0x7
    144a:	9a2080e7          	jalr	-1630(ra) # 7de8 <printf>
    exit(1);
    144e:	4505                	li	a0,1
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    1476:	2ce50513          	addi	a0,a0,718 # 8740 <malloc+0x766>
  ...
  if(fd < 0){
    ...
    149a:	2b250513          	addi	a0,a0,690 # 8748 <malloc+0x76e>
    149e:	00007097          	auipc	ra,0x7
    14a2:	94a080e7          	jalr	-1718(ra) # 7de8 <printf>
    exit(1);
    14a6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    14c0:	2ac58593          	addi	a1,a1,684 # 8768 <malloc+0x78e>
    14c4:	853e                	mv	a0,a5
    ...
    14e6:	29650513          	addi	a0,a0,662 # 8778 <malloc+0x79e>
    14ea:	00007097          	auipc	ra,0x7
    14ee:	8fe080e7          	jalr	-1794(ra) # 7de8 <printf>
      exit(1);
    14f2:	4505                	li	a0,1
    ...
    1506:	29e58593          	addi	a1,a1,670 # 87a0 <malloc+0x7c6>
    150a:	853e                	mv	a0,a5
    ...
    152c:	28850513          	addi	a0,a0,648 # 87b0 <malloc+0x7d6>
    1530:	00007097          	auipc	ra,0x7
    1534:	8b8080e7          	jalr	-1864(ra) # 7de8 <printf>
      exit(1);
    1538:	4505                	li	a0,1
  ...
  fd = open("small", O_RDONLY);
    ...
    1570:	1d450513          	addi	a0,a0,468 # 8740 <malloc+0x766>
  ...
  if(fd < 0){
    ...
    1594:	24850513          	addi	a0,a0,584 # 87d8 <malloc+0x7fe>
    1598:	00007097          	auipc	ra,0x7
    159c:	850080e7          	jalr	-1968(ra) # 7de8 <printf>
    exit(1);
    15a0:	4505                	li	a0,1
  ...
  if(i != N*SZ*2){
    ...
    15e2:	21a50513          	addi	a0,a0,538 # 87f8 <malloc+0x81e>
    15e6:	00007097          	auipc	ra,0x7
    15ea:	802080e7          	jalr	-2046(ra) # 7de8 <printf>
    exit(1);
    15ee:	4505                	li	a0,1
  ...
  if(unlink("small") < 0){
    ...
    160a:	13a50513          	addi	a0,a0,314 # 8740 <malloc+0x766>
    ...
    1624:	1f050513          	addi	a0,a0,496 # 8810 <malloc+0x836>
    1628:	00006097          	auipc	ra,0x6
    162c:	7c0080e7          	jalr	1984(ra) # 7de8 <printf>
    exit(1);
    1630:	4505                	li	a0,1
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1658:	1dc50513          	addi	a0,a0,476 # 8830 <malloc+0x856>
  ...
  if(fd < 0){
    ...
    167c:	1c050513          	addi	a0,a0,448 # 8838 <malloc+0x85e>
    1680:	00006097          	auipc	ra,0x6
    1684:	768080e7          	jalr	1896(ra) # 7de8 <printf>
    exit(1);
    1688:	4505                	li	a0,1
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    16da:	18250513          	addi	a0,a0,386 # 8858 <malloc+0x87e>
    16de:	00006097          	auipc	ra,0x6
    16e2:	70a080e7          	jalr	1802(ra) # 7de8 <printf>
      exit(1);
    16e6:	4505                	li	a0,1
  ...
  fd = open("big", O_RDONLY);
    ...
    171c:	11850513          	addi	a0,a0,280 # 8830 <malloc+0x856>
  ...
  if(fd < 0){
    ...
    1740:	14450513          	addi	a0,a0,324 # 8880 <malloc+0x8a6>
    1744:	00006097          	auipc	ra,0x6
    1748:	6a4080e7          	jalr	1700(ra) # 7de8 <printf>
    exit(1);
    174c:	4505                	li	a0,1
  ...
  for(;;){
    ...
    17a0:	10450513          	addi	a0,a0,260 # 88a0 <malloc+0x8c6>
    17a4:	00006097          	auipc	ra,0x6
    17a8:	644080e7          	jalr	1604(ra) # 7de8 <printf>
        exit(1);
    17ac:	4505                	li	a0,1
    ...
    17d4:	0f850513          	addi	a0,a0,248 # 88c8 <malloc+0x8ee>
    17d8:	00006097          	auipc	ra,0x6
    17dc:	610080e7          	jalr	1552(ra) # 7de8 <printf>
      exit(1);
    17e0:	4505                	li	a0,1
    ...
    1818:	0cc50513          	addi	a0,a0,204 # 88e0 <malloc+0x906>
    181c:	00006097          	auipc	ra,0x6
    1820:	5cc080e7          	jalr	1484(ra) # 7de8 <printf>
      exit(1);
    1824:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
    ...
    184e:	fe650513          	addi	a0,a0,-26 # 8830 <malloc+0x856>
    ...
    1868:	0a450513          	addi	a0,a0,164 # 8908 <malloc+0x92e>
    186c:	00006097          	auipc	ra,0x6
    1870:	57c080e7          	jalr	1404(ra) # 7de8 <printf>
    exit(1);
    1874:	4505                	li	a0,1
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    1964:	fc050513          	addi	a0,a0,-64 # 8920 <malloc+0x946>
    ...
    197e:	c7650513          	addi	a0,a0,-906 # 85f0 <malloc+0x616>
    1982:	00006097          	auipc	ra,0x6
    1986:	466080e7          	jalr	1126(ra) # 7de8 <printf>
    exit(1);
    198a:	4505                	li	a0,1
  ...
  if(chdir("dir0") < 0){
    ...
    1998:	f8c50513          	addi	a0,a0,-116 # 8920 <malloc+0x946>
    ...
    19b2:	f7a50513          	addi	a0,a0,-134 # 8928 <malloc+0x94e>
    19b6:	00006097          	auipc	ra,0x6
    19ba:	432080e7          	jalr	1074(ra) # 7de8 <printf>
    exit(1);
    19be:	4505                	li	a0,1
  ...
  if(chdir("..") < 0){
    ...
    19cc:	f7850513          	addi	a0,a0,-136 # 8940 <malloc+0x966>
    ...
    19e6:	f6650513          	addi	a0,a0,-154 # 8948 <malloc+0x96e>
    19ea:	00006097          	auipc	ra,0x6
    19ee:	3fe080e7          	jalr	1022(ra) # 7de8 <printf>
    exit(1);
    19f2:	4505                	li	a0,1
  ...
  if(unlink("dir0") < 0){
    ...
    1a00:	f2450513          	addi	a0,a0,-220 # 8920 <malloc+0x946>
    ...
    1a1a:	f4a50513          	addi	a0,a0,-182 # 8960 <malloc+0x986>
    1a1e:	00006097          	auipc	ra,0x6
    1a22:	3ca080e7          	jalr	970(ra) # 7de8 <printf>
    exit(1);
    1a26:	4505                	li	a0,1
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a4a:	8fa78793          	addi	a5,a5,-1798 # 8340 <malloc+0x366>
    1a4e:	fcf43423          	sd	a5,-56(s0)
    1a52:	00007797          	auipc	a5,0x7
    1a56:	f2678793          	addi	a5,a5,-218 # 8978 <malloc+0x99e>
  ...
  unlink("echo-ok");
    ...
    1a66:	f1e50513          	addi	a0,a0,-226 # 8980 <malloc+0x9a6>
  ...
  if(pid < 0) {
    ...
    1a92:	ad250513          	addi	a0,a0,-1326 # 8560 <malloc+0x586>
    1a96:	00006097          	auipc	ra,0x6
    1a9a:	352080e7          	jalr	850(ra) # 7de8 <printf>
     exit(1);
    1a9e:	4505                	li	a0,1
  ...
  if(pid == 0) {
    ...
    1ac2:	ec250513          	addi	a0,a0,-318 # 8980 <malloc+0x9a6>
    ...
    1ae6:	ea650513          	addi	a0,a0,-346 # 8988 <malloc+0x9ae>
    1aea:	00006097          	auipc	ra,0x6
    1aee:	2fe080e7          	jalr	766(ra) # 7de8 <printf>
      exit(1);
    1af2:	4505                	li	a0,1
    ...
    1b12:	e9250513          	addi	a0,a0,-366 # 89a0 <malloc+0x9c6>
    1b16:	00006097          	auipc	ra,0x6
    1b1a:	2d2080e7          	jalr	722(ra) # 7de8 <printf>
      exit(1);
    1b1e:	4505                	li	a0,1
    ...
    1b32:	81250513          	addi	a0,a0,-2030 # 8340 <malloc+0x366>
    ...
    1b4c:	e6850513          	addi	a0,a0,-408 # 89b0 <malloc+0x9d6>
    1b50:	00006097          	auipc	ra,0x6
    1b54:	298080e7          	jalr	664(ra) # 7de8 <printf>
      exit(1);
    1b58:	4505                	li	a0,1
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b86:	e4650513          	addi	a0,a0,-442 # 89c8 <malloc+0x9ee>
    1b8a:	00006097          	auipc	ra,0x6
    1b8e:	25e080e7          	jalr	606(ra) # 7de8 <printf>
  }
  if(xstatus != 0)
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1bac:	dd850513          	addi	a0,a0,-552 # 8980 <malloc+0x9a6>
  ...
  if(fd < 0) {
    ...
    1bd0:	9ac50513          	addi	a0,a0,-1620 # 8578 <malloc+0x59e>
    1bd4:	00006097          	auipc	ra,0x6
    1bd8:	214080e7          	jalr	532(ra) # 7de8 <printf>
    exit(1);
    1bdc:	4505                	li	a0,1
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c0e:	bee50513          	addi	a0,a0,-1042 # 87f8 <malloc+0x81e>
    1c12:	00006097          	auipc	ra,0x6
    1c16:	1d6080e7          	jalr	470(ra) # 7de8 <printf>
    exit(1);
    1c1a:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    1c28:	d5c50513          	addi	a0,a0,-676 # 8980 <malloc+0x9a6>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c62:	d8250513          	addi	a0,a0,-638 # 89e0 <malloc+0xa06>
    1c66:	00006097          	auipc	ra,0x6
    1c6a:	182080e7          	jalr	386(ra) # 7de8 <printf>
    exit(1);
    1c6e:	4505                	li	a0,1
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1c9e:	d5e50513          	addi	a0,a0,-674 # 89f8 <malloc+0xa1e>
    1ca2:	00006097          	auipc	ra,0x6
    1ca6:	146080e7          	jalr	326(ra) # 7de8 <printf>
    exit(1);
    1caa:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    1d52:	cc250513          	addi	a0,a0,-830 # 8a10 <malloc+0xa36>
    1d56:	00006097          	auipc	ra,0x6
    1d5a:	092080e7          	jalr	146(ra) # 7de8 <printf>
        exit(1);
    1d5e:	4505                	li	a0,1
    ...
    1dea:	c4250513          	addi	a0,a0,-958 # 8a28 <malloc+0xa4e>
    1dee:	00006097          	auipc	ra,0x6
    1df2:	ffa080e7          	jalr	-6(ra) # 7de8 <printf>
          return;
    ...
    1e8a:	bba50513          	addi	a0,a0,-1094 # 8a40 <malloc+0xa66>
    1e8e:	00006097          	auipc	ra,0x6
    1e92:	f5a080e7          	jalr	-166(ra) # 7de8 <printf>
      exit(1);
    1e96:	4505                	li	a0,1
    ...
    1ed2:	b9250513          	addi	a0,a0,-1134 # 8a60 <malloc+0xa86>
    1ed6:	00006097          	auipc	ra,0x6
    1eda:	f12080e7          	jalr	-238(ra) # 7de8 <printf>
    exit(1);
    1ede:	4505                	li	a0,1
...
killstatus(char *s)
{
  ...
  for(int i = 0; i < 100; i++){
    ...
    1f22:	64250513          	addi	a0,a0,1602 # 8560 <malloc+0x586>
    1f26:	00006097          	auipc	ra,0x6
    1f2a:	ec2080e7          	jalr	-318(ra) # 7de8 <printf>
      exit(1);
    1f2e:	4505                	li	a0,1
    ...
    1f84:	af850513          	addi	a0,a0,-1288 # 8a78 <malloc+0xa9e>
    1f88:	00006097          	auipc	ra,0x6
    1f8c:	e60080e7          	jalr	-416(ra) # 7de8 <printf>
       exit(1);
    1f90:	4505                	li	a0,1
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1fea:	ab250513          	addi	a0,a0,-1358 # 8a98 <malloc+0xabe>
    1fee:	00006097          	auipc	ra,0x6
    1ff2:	dfa080e7          	jalr	-518(ra) # 7de8 <printf>
    exit(1);
    1ff6:	4505                	li	a0,1
  ...
  if(pid2 < 0) {
    ...
    202c:	53850513          	addi	a0,a0,1336 # 8560 <malloc+0x586>
    2030:	00006097          	auipc	ra,0x6
    2034:	db8080e7          	jalr	-584(ra) # 7de8 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(pid3 < 0) {
    ...
    207c:	4e850513          	addi	a0,a0,1256 # 8560 <malloc+0x586>
    2080:	00006097          	auipc	ra,0x6
    2084:	d68080e7          	jalr	-664(ra) # 7de8 <printf>
     exit(1);
    2088:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    20b2:	18258593          	addi	a1,a1,386 # 8230 <malloc+0x256>
    20b6:	853e                	mv	a0,a5
    ...
    20d2:	9da50513          	addi	a0,a0,-1574 # 8aa8 <malloc+0xace>
    20d6:	00006097          	auipc	ra,0x6
    20da:	d12080e7          	jalr	-750(ra) # 7de8 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    2104:	00009597          	auipc	a1,0x9
    2108:	36c58593          	addi	a1,a1,876 # b470 <buf>
    210c:	853e                	mv	a0,a5
    ...
    2128:	99c50513          	addi	a0,a0,-1636 # 8ac0 <malloc+0xae6>
    212c:	00006097          	auipc	ra,0x6
    2130:	cbc080e7          	jalr	-836(ra) # 7de8 <printf>
  ...
  printf("kill... ");
    ...
    2148:	99450513          	addi	a0,a0,-1644 # 8ad8 <malloc+0xafe>
    214c:	00006097          	auipc	ra,0x6
    2150:	c9c080e7          	jalr	-868(ra) # 7de8 <printf>
  kill(pid1);
  ...
  printf("wait... ");
    ...
    2182:	96a50513          	addi	a0,a0,-1686 # 8ae8 <malloc+0xb0e>
    2186:	00006097          	auipc	ra,0x6
    218a:	c62080e7          	jalr	-926(ra) # 7de8 <printf>
  wait(0);
    218e:	4501                	li	a0,0
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    21e6:	37e50513          	addi	a0,a0,894 # 8560 <malloc+0x586>
    21ea:	00006097          	auipc	ra,0x6
    21ee:	bfe080e7          	jalr	-1026(ra) # 7de8 <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2228:	8d450513          	addi	a0,a0,-1836 # 8af8 <malloc+0xb1e>
    222c:	00006097          	auipc	ra,0x6
    2230:	bbc080e7          	jalr	-1092(ra) # 7de8 <printf>
        exit(1);
    2234:	4505                	li	a0,1
    ...
    2254:	8c050513          	addi	a0,a0,-1856 # 8b10 <malloc+0xb36>
    2258:	00006097          	auipc	ra,0x6
    225c:	b90080e7          	jalr	-1136(ra) # 7de8 <printf>
        exit(1);
    2260:	4505                	li	a0,1
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    22de:	28650513          	addi	a0,a0,646 # 8560 <malloc+0x586>
    22e2:	00006097          	auipc	ra,0x6
    22e6:	b06080e7          	jalr	-1274(ra) # 7de8 <printf>
      exit(1);
    22ea:	4505                	li	a0,1
    ...
    231c:	7e050513          	addi	a0,a0,2016 # 8af8 <malloc+0xb1e>
    2320:	00006097          	auipc	ra,0x6
    2324:	ac8080e7          	jalr	-1336(ra) # 7de8 <printf>
        exit(1);
    2328:	4505                	li	a0,1
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    23c2:	1a250513          	addi	a0,a0,418 # 8560 <malloc+0x586>
    23c6:	00006097          	auipc	ra,0x6
    23ca:	a22080e7          	jalr	-1502(ra) # 7de8 <printf>
      exit(1);
    23ce:	4505                	li	a0,1
    ...
    240a:	15a50513          	addi	a0,a0,346 # 8560 <malloc+0x586>
    240e:	00006097          	auipc	ra,0x6
    2412:	9da080e7          	jalr	-1574(ra) # 7de8 <printf>
        exit(1);
    2416:	4505                	li	a0,1
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    249e:	5fe50513          	addi	a0,a0,1534 # 8a98 <malloc+0xabe>
    24a2:	00006097          	auipc	ra,0x6
    24a6:	946080e7          	jalr	-1722(ra) # 7de8 <printf>
      exit(1);
    24aa:	4505                	li	a0,1
  ...
  for(int i = 0; i < N; i++){
    ...
    255e:	5d650513          	addi	a0,a0,1494 # 8b30 <malloc+0xb56>
    2562:	00006097          	auipc	ra,0x6
    2566:	886080e7          	jalr	-1914(ra) # 7de8 <printf>
      exit(1);
    256a:	4505                	li	a0,1
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    25a8:	5ac50513          	addi	a0,a0,1452 # 8b50 <malloc+0xb76>
  ...
  if(pid < 0){
    ...
    25d4:	4c850513          	addi	a0,a0,1224 # 8a98 <malloc+0xabe>
    25d8:	00006097          	auipc	ra,0x6
    25dc:	810080e7          	jalr	-2032(ra) # 7de8 <printf>
    exit(1);
    25e0:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    25f8:	55c50513          	addi	a0,a0,1372 # 8b50 <malloc+0xb76>
    ...
    2634:	52050513          	addi	a0,a0,1312 # 8b50 <malloc+0xb76>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    2660:	4f450513          	addi	a0,a0,1268 # 8b50 <malloc+0xb76>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    26c4:	c7050513          	addi	a0,a0,-912 # 8330 <malloc+0x356>
    26c8:	00005097          	auipc	ra,0x5
    26cc:	720080e7          	jalr	1824(ra) # 7de8 <printf>
      exit(1);
    26d0:	4505                	li	a0,1
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    276e:	870080e7          	jalr	-1936(ra) # 7fda <malloc>
    ...
    2790:	6ac080e7          	jalr	1708(ra) # 7e38 <free>
      m1 = m2;
    ...
    27a8:	836080e7          	jalr	-1994(ra) # 7fda <malloc>
    ...
    27be:	3a650513          	addi	a0,a0,934 # 8b60 <malloc+0xb86>
    27c2:	00005097          	auipc	ra,0x5
    27c6:	626080e7          	jalr	1574(ra) # 7de8 <printf>
      exit(1);
    27ca:	4505                	li	a0,1
    ...
    27dc:	660080e7          	jalr	1632(ra) # 7e38 <free>
    exit(0);
    27e0:	4501                	li	a0,0
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    2864:	33050513          	addi	a0,a0,816 # 8b90 <malloc+0xbb6>
    2868:	00005097          	auipc	ra,0x5
    286c:	580080e7          	jalr	1408(ra) # 7de8 <printf>
    exit(1);
    2870:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    28da:	2e250513          	addi	a0,a0,738 # 8bb8 <malloc+0xbde>
    28de:	00005097          	auipc	ra,0x5
    28e2:	50a080e7          	jalr	1290(ra) # 7de8 <printf>
      exit(1);
    28e6:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    2952:	23250513          	addi	a0,a0,562 # 8b80 <malloc+0xba6>
  ...
  if(fd < 0){
    ...
    2976:	26650513          	addi	a0,a0,614 # 8bd8 <malloc+0xbfe>
    297a:	00005097          	auipc	ra,0x5
    297e:	46e080e7          	jalr	1134(ra) # 7de8 <printf>
    exit(1);
    2982:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    2a2e:	15650513          	addi	a0,a0,342 # 8b80 <malloc+0xba6>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    2a70:	19450513          	addi	a0,a0,404 # 8c00 <malloc+0xc26>
    2a74:	00005097          	auipc	ra,0x5
    2a78:	374080e7          	jalr	884(ra) # 7de8 <printf>
    exit(1);
    2a7c:	4505                	li	a0,1
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    2a96:	1f678793          	addi	a5,a5,502 # 8c88 <malloc+0xcae>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2af6:	83e50513          	addi	a0,a0,-1986 # 8330 <malloc+0x356>
    2afa:	00005097          	auipc	ra,0x5
    2afe:	2ee080e7          	jalr	750(ra) # 7de8 <printf>
      exit(1);
    2b02:	4505                	li	a0,1
    ...
    2b3c:	0e050513          	addi	a0,a0,224 # 8c18 <malloc+0xc3e>
    2b40:	00005097          	auipc	ra,0x5
    2b44:	2a8080e7          	jalr	680(ra) # 7de8 <printf>
        exit(1);
    2b48:	4505                	li	a0,1
    ...
    2b66:	90e50513          	addi	a0,a0,-1778 # b470 <buf>
    ...
    2b84:	8f058593          	addi	a1,a1,-1808 # b470 <buf>
    2b88:	853e                	mv	a0,a5
    ...
    2bb2:	07a50513          	addi	a0,a0,122 # 8c28 <malloc+0xc4e>
    2bb6:	00005097          	auipc	ra,0x5
    2bba:	232080e7          	jalr	562(ra) # 7de8 <printf>
          exit(1);
    2bbe:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2c78:	a0b9                	j	2cc6 <fourfiles+0x240>
        if(buf[j] != '0'+i){
    2c7a:	00008717          	auipc	a4,0x8
    2c7e:	7f670713          	addi	a4,a4,2038 # b470 <buf>
    ...
    2ca6:	f9e50513          	addi	a0,a0,-98 # 8c40 <malloc+0xc66>
    2caa:	00005097          	auipc	ra,0x5
    2cae:	13e080e7          	jalr	318(ra) # 7de8 <printf>
          exit(1);
    2cb2:	4505                	li	a0,1
    ...
    2cee:	00008597          	auipc	a1,0x8
    2cf2:	78258593          	addi	a1,a1,1922 # b470 <buf>
    2cf6:	853e                	mv	a0,a5
    ...
    2d3a:	f1a50513          	addi	a0,a0,-230 # 8c50 <malloc+0xc76>
    2d3e:	00005097          	auipc	ra,0x5
    2d42:	0aa080e7          	jalr	170(ra) # 7de8 <printf>
      exit(1);
    2d46:	4505                	li	a0,1
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2db2:	58250513          	addi	a0,a0,1410 # 8330 <malloc+0x356>
    2db6:	00005097          	auipc	ra,0x5
    2dba:	032080e7          	jalr	50(ra) # 7de8 <printf>
      exit(1);
    2dbe:	4505                	li	a0,1
    ...
    2e2e:	b5e50513          	addi	a0,a0,-1186 # 8988 <malloc+0x9ae>
    2e32:	00005097          	auipc	ra,0x5
    2e36:	fb6080e7          	jalr	-74(ra) # 7de8 <printf>
          exit(1);
    2e3a:	4505                	li	a0,1
    ...
    2ea2:	83a50513          	addi	a0,a0,-1990 # 86d8 <malloc+0x6fe>
    2ea6:	00005097          	auipc	ra,0x5
    2eaa:	f42080e7          	jalr	-190(ra) # 7de8 <printf>
            exit(1);
    2eae:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    2fba:	cf250513          	addi	a0,a0,-782 # 8ca8 <malloc+0xcce>
    2fbe:	00005097          	auipc	ra,0x5
    2fc2:	e2a080e7          	jalr	-470(ra) # 7de8 <printf>
        exit(1);
    2fc6:	4505                	li	a0,1
    ...
    3000:	cd450513          	addi	a0,a0,-812 # 8cd0 <malloc+0xcf6>
    3004:	00005097          	auipc	ra,0x5
    3008:	de4080e7          	jalr	-540(ra) # 7de8 <printf>
        exit(1);
    300c:	4505                	li	a0,1
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    30f0:	c0c50513          	addi	a0,a0,-1012 # 8cf8 <malloc+0xd1e>
  ...
  if(fd < 0){
    ...
    3114:	bf850513          	addi	a0,a0,-1032 # 8d08 <malloc+0xd2e>
    3118:	00005097          	auipc	ra,0x5
    311c:	cd0080e7          	jalr	-816(ra) # 7de8 <printf>
    exit(1);
    3120:	4505                	li	a0,1
  ...
  write(fd, "hello", SZ);
    ...
    3134:	bf858593          	addi	a1,a1,-1032 # 8d28 <malloc+0xd4e>
    3138:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    3156:	ba650513          	addi	a0,a0,-1114 # 8cf8 <malloc+0xd1e>
  ...
  if(fd < 0){
    ...
    317a:	bba50513          	addi	a0,a0,-1094 # 8d30 <malloc+0xd56>
    317e:	00005097          	auipc	ra,0x5
    3182:	c6a080e7          	jalr	-918(ra) # 7de8 <printf>
    exit(1);
    3186:	4505                	li	a0,1
  ...
  if(unlink("unlinkread") != 0){
    ...
    3194:	b6850513          	addi	a0,a0,-1176 # 8cf8 <malloc+0xd1e>
    ...
    31ac:	ba850513          	addi	a0,a0,-1112 # 8d50 <malloc+0xd76>
    31b0:	00005097          	auipc	ra,0x5
    31b4:	c38080e7          	jalr	-968(ra) # 7de8 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    31ca:	b3250513          	addi	a0,a0,-1230 # 8cf8 <malloc+0xd1e>
  ...
  write(fd1, "yyy", 3);
    ...
    31e6:	b8e58593          	addi	a1,a1,-1138 # 8d70 <malloc+0xd96>
    31ea:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3208:	00008597          	auipc	a1,0x8
    320c:	26858593          	addi	a1,a1,616 # b470 <buf>
    3210:	853e                	mv	a0,a5
    ...
    322c:	b5050513          	addi	a0,a0,-1200 # 8d78 <malloc+0xd9e>
    3230:	00005097          	auipc	ra,0x5
    3234:	bb8080e7          	jalr	-1096(ra) # 7de8 <printf>
    exit(1);
    3238:	4505                	li	a0,1
  ...
  if(buf[0] != 'h'){
    3242:	00008797          	auipc	a5,0x8
    3246:	22e78793          	addi	a5,a5,558 # b470 <buf>
    ...
    3260:	b3c50513          	addi	a0,a0,-1220 # 8d98 <malloc+0xdbe>
    3264:	00005097          	auipc	ra,0x5
    3268:	b84080e7          	jalr	-1148(ra) # 7de8 <printf>
    exit(1);
    326c:	4505                	li	a0,1
  ...
  if(write(fd, buf, 10) != 10){
    ...
    327a:	4629                	li	a2,10
    327c:	00008597          	auipc	a1,0x8
    3280:	1f458593          	addi	a1,a1,500 # b470 <buf>
    3284:	853e                	mv	a0,a5
    ...
    32a0:	b1c50513          	addi	a0,a0,-1252 # 8db8 <malloc+0xdde>
    32a4:	00005097          	auipc	ra,0x5
    32a8:	b44080e7          	jalr	-1212(ra) # 7de8 <printf>
    exit(1);
    32ac:	4505                	li	a0,1
  ...
  unlink("unlinkread");
    ...
    32c8:	a3450513          	addi	a0,a0,-1484 # 8cf8 <malloc+0xd1e>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    ...
    32ee:	aee50513          	addi	a0,a0,-1298 # 8dd8 <malloc+0xdfe>
    32f2:	00004097          	auipc	ra,0x4
    32f6:	60e080e7          	jalr	1550(ra) # 7900 <unlink>
  unlink("lf2");
    32fa:	00006517          	auipc	a0,0x6
    32fe:	ae650513          	addi	a0,a0,-1306 # 8de0 <malloc+0xe06>
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    3312:	aca50513          	addi	a0,a0,-1334 # 8dd8 <malloc+0xdfe>
  ...
  if(fd < 0){
    ...
    3336:	ab650513          	addi	a0,a0,-1354 # 8de8 <malloc+0xe0e>
    333a:	00005097          	auipc	ra,0x5
    333e:	aae080e7          	jalr	-1362(ra) # 7de8 <printf>
    exit(1);
    3342:	4505                	li	a0,1
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    3356:	9d658593          	addi	a1,a1,-1578 # 8d28 <malloc+0xd4e>
    335a:	853e                	mv	a0,a5
    ...
    3376:	a8e50513          	addi	a0,a0,-1394 # 8e00 <malloc+0xe26>
    337a:	00005097          	auipc	ra,0x5
    337e:	a6e080e7          	jalr	-1426(ra) # 7de8 <printf>
    exit(1);
    3382:	4505                	li	a0,1
  ...
  if(link("lf1", "lf2") < 0){
    ...
    339e:	a4658593          	addi	a1,a1,-1466 # 8de0 <malloc+0xe06>
    33a2:	00006517          	auipc	a0,0x6
    33a6:	a3650513          	addi	a0,a0,-1482 # 8dd8 <malloc+0xdfe>
    ...
    33c0:	a5c50513          	addi	a0,a0,-1444 # 8e18 <malloc+0xe3e>
    33c4:	00005097          	auipc	ra,0x5
    33c8:	a24080e7          	jalr	-1500(ra) # 7de8 <printf>
    exit(1);
    33cc:	4505                	li	a0,1
  ...
  unlink("lf1");
    ...
    33da:	a0250513          	addi	a0,a0,-1534 # 8dd8 <malloc+0xdfe>
  ...
  if(open("lf1", 0) >= 0){
    ...
    33ec:	9f050513          	addi	a0,a0,-1552 # 8dd8 <malloc+0xdfe>
    ...
    3406:	a3650513          	addi	a0,a0,-1482 # 8e38 <malloc+0xe5e>
    340a:	00005097          	auipc	ra,0x5
    340e:	9de080e7          	jalr	-1570(ra) # 7de8 <printf>
    exit(1);
    3412:	4505                	li	a0,1
  ...
  fd = open("lf2", 0);
    ...
    3422:	9c250513          	addi	a0,a0,-1598 # 8de0 <malloc+0xe06>
  ...
  if(fd < 0){
    ...
    3446:	a2650513          	addi	a0,a0,-1498 # 8e68 <malloc+0xe8e>
    344a:	00005097          	auipc	ra,0x5
    344e:	99e080e7          	jalr	-1634(ra) # 7de8 <printf>
    exit(1);
    3452:	4505                	li	a0,1
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3462:	00008597          	auipc	a1,0x8
    3466:	00e58593          	addi	a1,a1,14 # b470 <buf>
    346a:	853e                	mv	a0,a5
    ...
    3486:	9fe50513          	addi	a0,a0,-1538 # 8e80 <malloc+0xea6>
    348a:	00005097          	auipc	ra,0x5
    348e:	95e080e7          	jalr	-1698(ra) # 7de8 <printf>
    exit(1);
    3492:	4505                	li	a0,1
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    34ae:	93658593          	addi	a1,a1,-1738 # 8de0 <malloc+0xe06>
    34b2:	00006517          	auipc	a0,0x6
    34b6:	92e50513          	addi	a0,a0,-1746 # 8de0 <malloc+0xe06>
    ...
    34d0:	9cc50513          	addi	a0,a0,-1588 # 8e98 <malloc+0xebe>
    34d4:	00005097          	auipc	ra,0x5
    34d8:	914080e7          	jalr	-1772(ra) # 7de8 <printf>
    exit(1);
    34dc:	4505                	li	a0,1
  ...
  unlink("lf2");
    ...
    34ea:	8fa50513          	addi	a0,a0,-1798 # 8de0 <malloc+0xe06>
    34ee:	00004097          	auipc	ra,0x4
    34f2:	412080e7          	jalr	1042(ra) # 7900 <unlink>
  if(link("lf2", "lf1") >= 0){
    34f6:	00006597          	auipc	a1,0x6
    34fa:	8e258593          	addi	a1,a1,-1822 # 8dd8 <malloc+0xdfe>
    34fe:	00006517          	auipc	a0,0x6
    3502:	8e250513          	addi	a0,a0,-1822 # 8de0 <malloc+0xe06>
    ...
    351c:	9a850513          	addi	a0,a0,-1624 # 8ec0 <malloc+0xee6>
    3520:	00005097          	auipc	ra,0x5
    3524:	8c8080e7          	jalr	-1848(ra) # 7de8 <printf>
    exit(1);
    3528:	4505                	li	a0,1
  ...
  if(link(".", "lf1") >= 0){
    ...
    3536:	8a658593          	addi	a1,a1,-1882 # 8dd8 <malloc+0xdfe>
    353a:	00006517          	auipc	a0,0x6
    353e:	9ae50513          	addi	a0,a0,-1618 # 8ee8 <malloc+0xf0e>
    ...
    3558:	99c50513          	addi	a0,a0,-1636 # 8ef0 <malloc+0xf16>
    355c:	00005097          	auipc	ra,0x5
    3560:	88c080e7          	jalr	-1908(ra) # 7de8 <printf>
    exit(1);
    3564:	4505                	li	a0,1
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    35ee:	92650513          	addi	a0,a0,-1754 # 8f10 <malloc+0xf36>
    ...
    3624:	8f050513          	addi	a0,a0,-1808 # 8f10 <malloc+0xf36>
    ...
    365e:	8be50513          	addi	a0,a0,-1858 # 8f18 <malloc+0xf3e>
    3662:	00004097          	auipc	ra,0x4
    3666:	786080e7          	jalr	1926(ra) # 7de8 <printf>
        exit(1);
    366a:	4505                	li	a0,1
  ...
  fd = open(".", 0);
    36e0:	4581                	li	a1,0
    36e2:	00006517          	auipc	a0,0x6
    36e6:	80650513          	addi	a0,a0,-2042 # 8ee8 <malloc+0xf0e>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    374e:	7ee50513          	addi	a0,a0,2030 # 8f38 <malloc+0xf5e>
    3752:	00004097          	auipc	ra,0x4
    3756:	696080e7          	jalr	1686(ra) # 7de8 <printf>
        exit(1);
    375a:	4505                	li	a0,1
    ...
    3782:	7da50513          	addi	a0,a0,2010 # 8f58 <malloc+0xf7e>
    3786:	00004097          	auipc	ra,0x4
    378a:	662080e7          	jalr	1634(ra) # 7de8 <printf>
        exit(1);
    378e:	4505                	li	a0,1
  ...
  if(n != N){
    ...
    37f6:	78e50513          	addi	a0,a0,1934 # 8f80 <malloc+0xfa6>
    37fa:	00004097          	auipc	ra,0x4
    37fe:	5ee080e7          	jalr	1518(ra) # 7de8 <printf>
    exit(1);
    3802:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3846:	d1e50513          	addi	a0,a0,-738 # 8560 <malloc+0x586>
    384a:	00004097          	auipc	ra,0x4
    384e:	59e080e7          	jalr	1438(ra) # 7de8 <printf>
      exit(1);
    3852:	4505                	li	a0,1
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    39e2:	85250513          	addi	a0,a0,-1966 # 8230 <malloc+0x256>
  ...
  if(pid < 0){
    ...
    3a0e:	b5650513          	addi	a0,a0,-1194 # 8560 <malloc+0x586>
    3a12:	00004097          	auipc	ra,0x4
    3a16:	3d6080e7          	jalr	982(ra) # 7de8 <printf>
    exit(1);
    3a1a:	4505                	li	a0,1
  ...
  for(i = 0; i < 100; i++){
    ...
    3a48:	e6d7879b          	addiw	a5,a5,-403 # 41c64e6d <freep+0x41c531d5>
    ...
    3a78:	7bc50513          	addi	a0,a0,1980 # 8230 <malloc+0x256>
    ...
    3aac:	78858593          	addi	a1,a1,1928 # 8230 <malloc+0x256>
    3ab0:	00005517          	auipc	a0,0x5
    3ab4:	50850513          	addi	a0,a0,1288 # 8fb8 <malloc+0xfde>
    ...
    3ac6:	76e50513          	addi	a0,a0,1902 # 8230 <malloc+0x256>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3b22:	4a250513          	addi	a0,a0,1186 # 8fc0 <malloc+0xfe6>
    3b26:	00004097          	auipc	ra,0x4
    3b2a:	dda080e7          	jalr	-550(ra) # 7900 <unlink>
  if(mkdir("dd") != 0){
    3b2e:	00005517          	auipc	a0,0x5
    3b32:	49a50513          	addi	a0,a0,1178 # 8fc8 <malloc+0xfee>
    ...
    3b4a:	48a50513          	addi	a0,a0,1162 # 8fd0 <malloc+0xff6>
    3b4e:	00004097          	auipc	ra,0x4
    3b52:	29a080e7          	jalr	666(ra) # 7de8 <printf>
    exit(1);
    3b56:	4505                	li	a0,1
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3b68:	48450513          	addi	a0,a0,1156 # 8fe8 <malloc+0x100e>
  ...
  if(fd < 0){
    ...
    3b8c:	46850513          	addi	a0,a0,1128 # 8ff0 <malloc+0x1016>
    3b90:	00004097          	auipc	ra,0x4
    3b94:	258080e7          	jalr	600(ra) # 7de8 <printf>
    exit(1);
    3b98:	4505                	li	a0,1
  ...
  write(fd, "ff", 2);
    ...
    3bac:	41858593          	addi	a1,a1,1048 # 8fc0 <malloc+0xfe6>
    3bb0:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3bcc:	40050513          	addi	a0,a0,1024 # 8fc8 <malloc+0xfee>
    ...
    3be6:	42e50513          	addi	a0,a0,1070 # 9010 <malloc+0x1036>
    3bea:	00004097          	auipc	ra,0x4
    3bee:	1fe080e7          	jalr	510(ra) # 7de8 <printf>
    exit(1);
    3bf2:	4505                	li	a0,1
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3c00:	44450513          	addi	a0,a0,1092 # 9040 <malloc+0x1066>
    ...
    3c18:	43450513          	addi	a0,a0,1076 # 9048 <malloc+0x106e>
    3c1c:	00004097          	auipc	ra,0x4
    3c20:	1cc080e7          	jalr	460(ra) # 7de8 <printf>
    exit(1);
    3c24:	4505                	li	a0,1
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3c36:	43650513          	addi	a0,a0,1078 # 9068 <malloc+0x108e>
  ...
  if(fd < 0){
    ...
    3c5a:	42250513          	addi	a0,a0,1058 # 9078 <malloc+0x109e>
    3c5e:	00004097          	auipc	ra,0x4
    3c62:	18a080e7          	jalr	394(ra) # 7de8 <printf>
    exit(1);
    3c66:	4505                	li	a0,1
  ...
  write(fd, "FF", 2);
    ...
    3c7a:	42258593          	addi	a1,a1,1058 # 9098 <malloc+0x10be>
    3c7e:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3c9c:	40850513          	addi	a0,a0,1032 # 90a0 <malloc+0x10c6>
  ...
  if(fd < 0){
    ...
    3cc0:	3f450513          	addi	a0,a0,1012 # 90b0 <malloc+0x10d6>
    3cc4:	00004097          	auipc	ra,0x4
    3cc8:	124080e7          	jalr	292(ra) # 7de8 <printf>
    exit(1);
    3ccc:	4505                	li	a0,1
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3cdc:	00007597          	auipc	a1,0x7
    3ce0:	79458593          	addi	a1,a1,1940 # b470 <buf>
    3ce4:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3d02:	00007797          	auipc	a5,0x7
    3d06:	76e78793          	addi	a5,a5,1902 # b470 <buf>
    ...
    3d20:	3b450513          	addi	a0,a0,948 # 90d0 <malloc+0x10f6>
    3d24:	00004097          	auipc	ra,0x4
    3d28:	0c4080e7          	jalr	196(ra) # 7de8 <printf>
    exit(1);
    3d2c:	4505                	li	a0,1
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3d48:	3ac58593          	addi	a1,a1,940 # 90f0 <malloc+0x1116>
    3d4c:	00005517          	auipc	a0,0x5
    3d50:	31c50513          	addi	a0,a0,796 # 9068 <malloc+0x108e>
    ...
    3d68:	39c50513          	addi	a0,a0,924 # 9100 <malloc+0x1126>
    3d6c:	00004097          	auipc	ra,0x4
    3d70:	07c080e7          	jalr	124(ra) # 7de8 <printf>
    exit(1);
    3d74:	4505                	li	a0,1
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3d82:	2ea50513          	addi	a0,a0,746 # 9068 <malloc+0x108e>
    ...
    3d9a:	39250513          	addi	a0,a0,914 # 9128 <malloc+0x114e>
    3d9e:	00004097          	auipc	ra,0x4
    3da2:	04a080e7          	jalr	74(ra) # 7de8 <printf>
    exit(1);
    3da6:	4505                	li	a0,1
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3db6:	2b650513          	addi	a0,a0,694 # 9068 <malloc+0x108e>
    ...
    3dd0:	37c50513          	addi	a0,a0,892 # 9148 <malloc+0x116e>
    3dd4:	00004097          	auipc	ra,0x4
    3dd8:	014080e7          	jalr	20(ra) # 7de8 <printf>
    exit(1);
    3ddc:	4505                	li	a0,1
  ...
  if(chdir("dd") != 0){
    ...
    3dea:	1e250513          	addi	a0,a0,482 # 8fc8 <malloc+0xfee>
    ...
    3e02:	37250513          	addi	a0,a0,882 # 9170 <malloc+0x1196>
    3e06:	00004097          	auipc	ra,0x4
    3e0a:	fe2080e7          	jalr	-30(ra) # 7de8 <printf>
    exit(1);
    3e0e:	4505                	li	a0,1
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3e1c:	37050513          	addi	a0,a0,880 # 9188 <malloc+0x11ae>
    ...
    3e34:	36850513          	addi	a0,a0,872 # 9198 <malloc+0x11be>
    3e38:	00004097          	auipc	ra,0x4
    3e3c:	fb0080e7          	jalr	-80(ra) # 7de8 <printf>
    exit(1);
    3e40:	4505                	li	a0,1
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3e4e:	36e50513          	addi	a0,a0,878 # 91b8 <malloc+0x11de>
    ...
    3e66:	36650513          	addi	a0,a0,870 # 91c8 <malloc+0x11ee>
    3e6a:	00004097          	auipc	ra,0x4
    3e6e:	f7e080e7          	jalr	-130(ra) # 7de8 <printf>
    exit(1);
    3e72:	4505                	li	a0,1
  ...
  if(chdir("./..") != 0){
    ...
    3e80:	36c50513          	addi	a0,a0,876 # 91e8 <malloc+0x120e>
    ...
    3e98:	35c50513          	addi	a0,a0,860 # 91f0 <malloc+0x1216>
    3e9c:	00004097          	auipc	ra,0x4
    3ea0:	f4c080e7          	jalr	-180(ra) # 7de8 <printf>
    exit(1);
    3ea4:	4505                	li	a0,1
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3eb4:	24050513          	addi	a0,a0,576 # 90f0 <malloc+0x1116>
  ...
  if(fd < 0){
    ...
    3ed8:	33450513          	addi	a0,a0,820 # 9208 <malloc+0x122e>
    3edc:	00004097          	auipc	ra,0x4
    3ee0:	f0c080e7          	jalr	-244(ra) # 7de8 <printf>
    exit(1);
    3ee4:	4505                	li	a0,1
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    3ef4:	00007597          	auipc	a1,0x7
    3ef8:	57c58593          	addi	a1,a1,1404 # b470 <buf>
    3efc:	853e                	mv	a0,a5
    ...
    3f18:	31450513          	addi	a0,a0,788 # 9228 <malloc+0x124e>
    3f1c:	00004097          	auipc	ra,0x4
    3f20:	ecc080e7          	jalr	-308(ra) # 7de8 <printf>
    exit(1);
    3f24:	4505                	li	a0,1
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3f42:	12a50513          	addi	a0,a0,298 # 9068 <malloc+0x108e>
    ...
    3f5c:	2f050513          	addi	a0,a0,752 # 9248 <malloc+0x126e>
    3f60:	00004097          	auipc	ra,0x4
    3f64:	e88080e7          	jalr	-376(ra) # 7de8 <printf>
    exit(1);
    3f68:	4505                	li	a0,1
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3f7a:	30250513          	addi	a0,a0,770 # 9278 <malloc+0x129e>
    ...
    3f94:	2f850513          	addi	a0,a0,760 # 9288 <malloc+0x12ae>
    3f98:	00004097          	auipc	ra,0x4
    3f9c:	e50080e7          	jalr	-432(ra) # 7de8 <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3fb2:	2fa50513          	addi	a0,a0,762 # 92a8 <malloc+0x12ce>
    ...
    3fcc:	2f050513          	addi	a0,a0,752 # 92b8 <malloc+0x12de>
    3fd0:	00004097          	auipc	ra,0x4
    3fd4:	e18080e7          	jalr	-488(ra) # 7de8 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3fea:	fe250513          	addi	a0,a0,-30 # 8fc8 <malloc+0xfee>
    ...
    4004:	2d850513          	addi	a0,a0,728 # 92d8 <malloc+0x12fe>
    4008:	00004097          	auipc	ra,0x4
    400c:	de0080e7          	jalr	-544(ra) # 7de8 <printf>
    exit(1);
    4010:	4505                	li	a0,1
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    4020:	fac50513          	addi	a0,a0,-84 # 8fc8 <malloc+0xfee>
    ...
    403a:	2c250513          	addi	a0,a0,706 # 92f8 <malloc+0x131e>
    403e:	00004097          	auipc	ra,0x4
    4042:	daa080e7          	jalr	-598(ra) # 7de8 <printf>
    exit(1);
    4046:	4505                	li	a0,1
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    4056:	f7650513          	addi	a0,a0,-138 # 8fc8 <malloc+0xfee>
    ...
    4070:	2ac50513          	addi	a0,a0,684 # 9318 <malloc+0x133e>
    4074:	00004097          	auipc	ra,0x4
    4078:	d74080e7          	jalr	-652(ra) # 7de8 <printf>
    exit(1);
    407c:	4505                	li	a0,1
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    408a:	2b258593          	addi	a1,a1,690 # 9338 <malloc+0x135e>
    408e:	00005517          	auipc	a0,0x5
    4092:	1ea50513          	addi	a0,a0,490 # 9278 <malloc+0x129e>
    ...
    40aa:	2a250513          	addi	a0,a0,674 # 9348 <malloc+0x136e>
    40ae:	00004097          	auipc	ra,0x4
    40b2:	d3a080e7          	jalr	-710(ra) # 7de8 <printf>
    exit(1);
    40b6:	4505                	li	a0,1
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    40c4:	27858593          	addi	a1,a1,632 # 9338 <malloc+0x135e>
    40c8:	00005517          	auipc	a0,0x5
    40cc:	1e050513          	addi	a0,a0,480 # 92a8 <malloc+0x12ce>
    ...
    40e4:	29050513          	addi	a0,a0,656 # 9370 <malloc+0x1396>
    40e8:	00004097          	auipc	ra,0x4
    40ec:	d00080e7          	jalr	-768(ra) # 7de8 <printf>
    exit(1);
    40f0:	4505                	li	a0,1
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    40fe:	ff658593          	addi	a1,a1,-10 # 90f0 <malloc+0x1116>
    4102:	00005517          	auipc	a0,0x5
    4106:	ee650513          	addi	a0,a0,-282 # 8fe8 <malloc+0x100e>
    ...
    411e:	27e50513          	addi	a0,a0,638 # 9398 <malloc+0x13be>
    4122:	00004097          	auipc	ra,0x4
    4126:	cc6080e7          	jalr	-826(ra) # 7de8 <printf>
    exit(1);
    412a:	4505                	li	a0,1
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    4138:	14450513          	addi	a0,a0,324 # 9278 <malloc+0x129e>
    ...
    4150:	27450513          	addi	a0,a0,628 # 93c0 <malloc+0x13e6>
    4154:	00004097          	auipc	ra,0x4
    4158:	c94080e7          	jalr	-876(ra) # 7de8 <printf>
    exit(1);
    415c:	4505                	li	a0,1
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    416a:	14250513          	addi	a0,a0,322 # 92a8 <malloc+0x12ce>
    ...
    4182:	26250513          	addi	a0,a0,610 # 93e0 <malloc+0x1406>
    4186:	00004097          	auipc	ra,0x4
    418a:	c62080e7          	jalr	-926(ra) # 7de8 <printf>
    exit(1);
    418e:	4505                	li	a0,1
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    419c:	f5850513          	addi	a0,a0,-168 # 90f0 <malloc+0x1116>
    ...
    41b4:	25050513          	addi	a0,a0,592 # 9400 <malloc+0x1426>
    41b8:	00004097          	auipc	ra,0x4
    41bc:	c30080e7          	jalr	-976(ra) # 7de8 <printf>
    exit(1);
    41c0:	4505                	li	a0,1
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    41ce:	0de50513          	addi	a0,a0,222 # 92a8 <malloc+0x12ce>
    ...
    41e6:	24650513          	addi	a0,a0,582 # 9428 <malloc+0x144e>
    41ea:	00004097          	auipc	ra,0x4
    41ee:	bfe080e7          	jalr	-1026(ra) # 7de8 <printf>
    exit(1);
    41f2:	4505                	li	a0,1
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    4200:	07c50513          	addi	a0,a0,124 # 9278 <malloc+0x129e>
    ...
    4218:	23450513          	addi	a0,a0,564 # 9448 <malloc+0x146e>
    421c:	00004097          	auipc	ra,0x4
    4220:	bcc080e7          	jalr	-1076(ra) # 7de8 <printf>
    exit(1);
    4224:	4505                	li	a0,1
  ...
  if(chdir("dd/ff") == 0){
    ...
    4232:	dba50513          	addi	a0,a0,-582 # 8fe8 <malloc+0x100e>
    ...
    424a:	22250513          	addi	a0,a0,546 # 9468 <malloc+0x148e>
    424e:	00004097          	auipc	ra,0x4
    4252:	b9a080e7          	jalr	-1126(ra) # 7de8 <printf>
    exit(1);
    4256:	4505                	li	a0,1
  ...
  if(chdir("dd/xx") == 0){
    ...
    4264:	22850513          	addi	a0,a0,552 # 9488 <malloc+0x14ae>
    ...
    427c:	21850513          	addi	a0,a0,536 # 9490 <malloc+0x14b6>
    4280:	00004097          	auipc	ra,0x4
    4284:	b68080e7          	jalr	-1176(ra) # 7de8 <printf>
    exit(1);
    4288:	4505                	li	a0,1
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    4296:	e5e50513          	addi	a0,a0,-418 # 90f0 <malloc+0x1116>
    ...
    42ae:	e7e50513          	addi	a0,a0,-386 # 9128 <malloc+0x114e>
    42b2:	00004097          	auipc	ra,0x4
    42b6:	b36080e7          	jalr	-1226(ra) # 7de8 <printf>
    exit(1);
    42ba:	4505                	li	a0,1
  ...
  if(unlink("dd/ff") != 0){
    ...
    42c8:	d2450513          	addi	a0,a0,-732 # 8fe8 <malloc+0x100e>
    ...
    42e0:	1d450513          	addi	a0,a0,468 # 94b0 <malloc+0x14d6>
    42e4:	00004097          	auipc	ra,0x4
    42e8:	b04080e7          	jalr	-1276(ra) # 7de8 <printf>
    exit(1);
    42ec:	4505                	li	a0,1
  ...
  if(unlink("dd") == 0){
    ...
    42fa:	cd250513          	addi	a0,a0,-814 # 8fc8 <malloc+0xfee>
    ...
    4312:	1c250513          	addi	a0,a0,450 # 94d0 <malloc+0x14f6>
    4316:	00004097          	auipc	ra,0x4
    431a:	ad2080e7          	jalr	-1326(ra) # 7de8 <printf>
    exit(1);
    431e:	4505                	li	a0,1
  ...
  if(unlink("dd/dd") < 0){
    ...
    432c:	1d050513          	addi	a0,a0,464 # 94f8 <malloc+0x151e>
    ...
    4346:	1be50513          	addi	a0,a0,446 # 9500 <malloc+0x1526>
    434a:	00004097          	auipc	ra,0x4
    434e:	a9e080e7          	jalr	-1378(ra) # 7de8 <printf>
    exit(1);
    4352:	4505                	li	a0,1
  ...
  if(unlink("dd") < 0){
    ...
    4360:	c6c50513          	addi	a0,a0,-916 # 8fc8 <malloc+0xfee>
    ...
    437a:	1aa50513          	addi	a0,a0,426 # 9520 <malloc+0x1546>
    437e:	00004097          	auipc	ra,0x4
    4382:	a6a080e7          	jalr	-1430(ra) # 7de8 <printf>
    exit(1);
    4386:	4505                	li	a0,1
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    ...
    43aa:	19250513          	addi	a0,a0,402 # 9538 <malloc+0x155e>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    43c8:	17450513          	addi	a0,a0,372 # 9538 <malloc+0x155e>
    ...
    43ec:	16050513          	addi	a0,a0,352 # 9548 <malloc+0x156e>
    43f0:	00004097          	auipc	ra,0x4
    43f4:	9f8080e7          	jalr	-1544(ra) # 7de8 <printf>
      exit(1);
    43f8:	4505                	li	a0,1
    ...
    4410:	863a                	mv	a2,a4
    4412:	00007597          	auipc	a1,0x7
    4416:	05e58593          	addi	a1,a1,94 # b470 <buf>
    441a:	853e                	mv	a0,a5
    ...
    4450:	11c50513          	addi	a0,a0,284 # 9568 <malloc+0x158e>
    4454:	00004097          	auipc	ra,0x4
    4458:	994080e7          	jalr	-1644(ra) # 7de8 <printf>
        exit(1);
    445c:	4505                	li	a0,1
    ...
    4490:	0ac50513          	addi	a0,a0,172 # 9538 <malloc+0x155e>
...
bigfile(char *s)
{
  ...
  if(fd < 0){
    ...
    450a:	08a50513          	addi	a0,a0,138 # 9590 <malloc+0x15b6>
    450e:	00004097          	auipc	ra,0x4
    4512:	8da080e7          	jalr	-1830(ra) # 7de8 <printf>
    exit(1);
    4516:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    452e:	85be                	mv	a1,a5
    4530:	00007517          	auipc	a0,0x7
    4534:	f4050513          	addi	a0,a0,-192 # b470 <buf>
    4538:	00003097          	auipc	ra,0x3
    453c:	fcc080e7          	jalr	-52(ra) # 7504 <memset>
    if(write(fd, buf, SZ) != SZ){
    4540:	fe442783          	lw	a5,-28(s0)
    4544:	25800613          	li	a2,600
    4548:	00007597          	auipc	a1,0x7
    454c:	f2858593          	addi	a1,a1,-216 # b470 <buf>
    4550:	853e                	mv	a0,a5
    ...
    456e:	04650513          	addi	a0,a0,70 # 95b0 <malloc+0x15d6>
    4572:	00004097          	auipc	ra,0x4
    4576:	876080e7          	jalr	-1930(ra) # 7de8 <printf>
      exit(1);
    457a:	4505                	li	a0,1
  ...
  fd = open("bigfile.dat", 0);
    ...
    45b0:	fd450513          	addi	a0,a0,-44 # 9580 <malloc+0x15a6>
  ...
  if(fd < 0){
    ...
    45d4:	00050513          	mv	a0,a0
    45d8:	00004097          	auipc	ra,0x4
    45dc:	810080e7          	jalr	-2032(ra) # 7de8 <printf>
    exit(1);
    45e0:	4505                	li	a0,1
  ...
  for(i = 0; ; i++){
    ...
    45fa:	00007597          	auipc	a1,0x7
    45fe:	e7658593          	addi	a1,a1,-394 # b470 <buf>
    4602:	853e                	mv	a0,a5
    ...
    4624:	fd050513          	addi	a0,a0,-48 # 95f0 <malloc+0x1616>
    4628:	00003097          	auipc	ra,0x3
    462c:	7c0080e7          	jalr	1984(ra) # 7de8 <printf>
      exit(1);
    4630:	4505                	li	a0,1
    ...
    465a:	fba50513          	addi	a0,a0,-70 # 9610 <malloc+0x1636>
    465e:	00003097          	auipc	ra,0x3
    4662:	78a080e7          	jalr	1930(ra) # 7de8 <printf>
      exit(1);
    4666:	4505                	li	a0,1
    ...
    4670:	00007797          	auipc	a5,0x7
    4674:	e0078793          	addi	a5,a5,-512 # b470 <buf>
    ...
    4696:	00007797          	auipc	a5,0x7
    469a:	dda78793          	addi	a5,a5,-550 # b470 <buf>
    ...
    46c4:	f6850513          	addi	a0,a0,-152 # 9628 <malloc+0x164e>
    46c8:	00003097          	auipc	ra,0x3
    46cc:	720080e7          	jalr	1824(ra) # 7de8 <printf>
      exit(1);
    46d0:	4505                	li	a0,1
  ...
  if(total != N*SZ){
    ...
    4720:	f2c50513          	addi	a0,a0,-212 # 9648 <malloc+0x166e>
    4724:	00003097          	auipc	ra,0x3
    4728:	6c4080e7          	jalr	1732(ra) # 7de8 <printf>
    exit(1);
    472c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    473a:	e4a50513          	addi	a0,a0,-438 # 9580 <malloc+0x15a6>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    4760:	f0c50513          	addi	a0,a0,-244 # 9668 <malloc+0x168e>
    ...
    4778:	f0450513          	addi	a0,a0,-252 # 9678 <malloc+0x169e>
    477c:	00003097          	auipc	ra,0x3
    4780:	66c080e7          	jalr	1644(ra) # 7de8 <printf>
    exit(1);
    4784:	4505                	li	a0,1
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    4792:	f1250513          	addi	a0,a0,-238 # 96a0 <malloc+0x16c6>
    ...
    47aa:	f1a50513          	addi	a0,a0,-230 # 96c0 <malloc+0x16e6>
    47ae:	00003097          	auipc	ra,0x3
    47b2:	63a080e7          	jalr	1594(ra) # 7de8 <printf>
    exit(1);
    47b6:	4505                	li	a0,1
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    47c8:	f3450513          	addi	a0,a0,-204 # 96f8 <malloc+0x171e>
  ...
  if(fd < 0){
    ...
    47ec:	f4050513          	addi	a0,a0,-192 # 9728 <malloc+0x174e>
    47f0:	00003097          	auipc	ra,0x3
    47f4:	5f8080e7          	jalr	1528(ra) # 7de8 <printf>
    exit(1);
    47f8:	4505                	li	a0,1
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    4816:	f5e50513          	addi	a0,a0,-162 # 9770 <malloc+0x1796>
  ...
  if(fd < 0){
    ...
    483a:	f6a50513          	addi	a0,a0,-150 # 97a0 <malloc+0x17c6>
    483e:	00003097          	auipc	ra,0x3
    4842:	5aa080e7          	jalr	1450(ra) # 7de8 <printf>
    exit(1);
    4846:	4505                	li	a0,1
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    4862:	f8250513          	addi	a0,a0,-126 # 97e0 <malloc+0x1806>
    ...
    487a:	f8a50513          	addi	a0,a0,-118 # 9800 <malloc+0x1826>
    487e:	00003097          	auipc	ra,0x3
    4882:	56a080e7          	jalr	1386(ra) # 7de8 <printf>
    exit(1);
    4886:	4505                	li	a0,1
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    4894:	fa850513          	addi	a0,a0,-88 # 9838 <malloc+0x185e>
    ...
    48ac:	fb050513          	addi	a0,a0,-80 # 9858 <malloc+0x187e>
    48b0:	00003097          	auipc	ra,0x3
    48b4:	538080e7          	jalr	1336(ra) # 7de8 <printf>
    exit(1);
    48b8:	4505                	li	a0,1
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    ...
    493c:	f5850513          	addi	a0,a0,-168 # 9890 <malloc+0x18b6>
    ...
    4954:	f4850513          	addi	a0,a0,-184 # 9898 <malloc+0x18be>
    4958:	00003097          	auipc	ra,0x3
    495c:	490080e7          	jalr	1168(ra) # 7de8 <printf>
    exit(1);
    4960:	4505                	li	a0,1
  ...
  if(chdir("dots") != 0){
    ...
    496e:	f2650513          	addi	a0,a0,-218 # 9890 <malloc+0x18b6>
    ...
    4986:	f2e50513          	addi	a0,a0,-210 # 98b0 <malloc+0x18d6>
    498a:	00003097          	auipc	ra,0x3
    498e:	45e080e7          	jalr	1118(ra) # 7de8 <printf>
    exit(1);
    4992:	4505                	li	a0,1
  ...
  if(unlink(".") == 0){
    ...
    49a0:	54c50513          	addi	a0,a0,1356 # 8ee8 <malloc+0xf0e>
    ...
    49b8:	f1450513          	addi	a0,a0,-236 # 98c8 <malloc+0x18ee>
    49bc:	00003097          	auipc	ra,0x3
    49c0:	42c080e7          	jalr	1068(ra) # 7de8 <printf>
    exit(1);
    49c4:	4505                	li	a0,1
  ...
  if(unlink("..") == 0){
    ...
    49d2:	f7250513          	addi	a0,a0,-142 # 8940 <malloc+0x966>
    ...
    49ea:	efa50513          	addi	a0,a0,-262 # 98e0 <malloc+0x1906>
    49ee:	00003097          	auipc	ra,0x3
    49f2:	3fa080e7          	jalr	1018(ra) # 7de8 <printf>
    exit(1);
    49f6:	4505                	li	a0,1
  ...
  if(chdir("/") != 0){
    ...
    4a04:	c5850513          	addi	a0,a0,-936 # 8658 <malloc+0x67e>
    ...
    4a1c:	c4850513          	addi	a0,a0,-952 # 8660 <malloc+0x686>
    4a20:	00003097          	auipc	ra,0x3
    4a24:	3c8080e7          	jalr	968(ra) # 7de8 <printf>
    exit(1);
    4a28:	4505                	li	a0,1
  ...
  if(unlink("dots/.") == 0){
    ...
    4a36:	ec650513          	addi	a0,a0,-314 # 98f8 <malloc+0x191e>
    ...
    4a4e:	eb650513          	addi	a0,a0,-330 # 9900 <malloc+0x1926>
    4a52:	00003097          	auipc	ra,0x3
    4a56:	396080e7          	jalr	918(ra) # 7de8 <printf>
    exit(1);
    4a5a:	4505                	li	a0,1
  ...
  if(unlink("dots/..") == 0){
    ...
    4a68:	ebc50513          	addi	a0,a0,-324 # 9920 <malloc+0x1946>
    ...
    4a80:	eac50513          	addi	a0,a0,-340 # 9928 <malloc+0x194e>
    4a84:	00003097          	auipc	ra,0x3
    4a88:	364080e7          	jalr	868(ra) # 7de8 <printf>
    exit(1);
    4a8c:	4505                	li	a0,1
  ...
  if(unlink("dots") != 0){
    ...
    4a9a:	dfa50513          	addi	a0,a0,-518 # 9890 <malloc+0x18b6>
    ...
    4ab2:	e9a50513          	addi	a0,a0,-358 # 9948 <malloc+0x196e>
    4ab6:	00003097          	auipc	ra,0x3
    4aba:	332080e7          	jalr	818(ra) # 7de8 <printf>
    exit(1);
    4abe:	4505                	li	a0,1
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4ae6:	e8650513          	addi	a0,a0,-378 # 9968 <malloc+0x198e>
  ...
  if(fd < 0){
    ...
    4b0a:	e6a50513          	addi	a0,a0,-406 # 9970 <malloc+0x1996>
    4b0e:	00003097          	auipc	ra,0x3
    4b12:	2da080e7          	jalr	730(ra) # 7de8 <printf>
    exit(1);
    4b16:	4505                	li	a0,1
  ...
  if(chdir("dirfile") == 0){
    ...
    4b32:	e3a50513          	addi	a0,a0,-454 # 9968 <malloc+0x198e>
    ...
    4b4a:	e4a50513          	addi	a0,a0,-438 # 9990 <malloc+0x19b6>
    4b4e:	00003097          	auipc	ra,0x3
    4b52:	29a080e7          	jalr	666(ra) # 7de8 <printf>
    exit(1);
    4b56:	4505                	li	a0,1
  ...
  fd = open("dirfile/xx", 0);
    ...
    4b66:	e4e50513          	addi	a0,a0,-434 # 99b0 <malloc+0x19d6>
  ...
  if(fd >= 0){
    ...
    4b8a:	e3a50513          	addi	a0,a0,-454 # 99c0 <malloc+0x19e6>
    4b8e:	00003097          	auipc	ra,0x3
    4b92:	25a080e7          	jalr	602(ra) # 7de8 <printf>
    exit(1);
    4b96:	4505                	li	a0,1
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4ba8:	e0c50513          	addi	a0,a0,-500 # 99b0 <malloc+0x19d6>
  ...
  if(fd >= 0){
    ...
    4bcc:	df850513          	addi	a0,a0,-520 # 99c0 <malloc+0x19e6>
    4bd0:	00003097          	auipc	ra,0x3
    4bd4:	218080e7          	jalr	536(ra) # 7de8 <printf>
    exit(1);
    4bd8:	4505                	li	a0,1
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4be6:	dce50513          	addi	a0,a0,-562 # 99b0 <malloc+0x19d6>
    ...
    4bfe:	dee50513          	addi	a0,a0,-530 # 99e8 <malloc+0x1a0e>
    4c02:	00003097          	auipc	ra,0x3
    4c06:	1e6080e7          	jalr	486(ra) # 7de8 <printf>
    exit(1);
    4c0a:	4505                	li	a0,1
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4c18:	d9c50513          	addi	a0,a0,-612 # 99b0 <malloc+0x19d6>
    ...
    4c30:	de450513          	addi	a0,a0,-540 # 9a10 <malloc+0x1a36>
    4c34:	00003097          	auipc	ra,0x3
    4c38:	1b4080e7          	jalr	436(ra) # 7de8 <printf>
    exit(1);
    4c3c:	4505                	li	a0,1
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4c4a:	d6a58593          	addi	a1,a1,-662 # 99b0 <malloc+0x19d6>
    4c4e:	00003517          	auipc	a0,0x3
    4c52:	59250513          	addi	a0,a0,1426 # 81e0 <malloc+0x206>
    ...
    4c6a:	dd250513          	addi	a0,a0,-558 # 9a38 <malloc+0x1a5e>
    4c6e:	00003097          	auipc	ra,0x3
    4c72:	17a080e7          	jalr	378(ra) # 7de8 <printf>
    exit(1);
    4c76:	4505                	li	a0,1
  ...
  if(unlink("dirfile") != 0){
    ...
    4c84:	ce850513          	addi	a0,a0,-792 # 9968 <malloc+0x198e>
    ...
    4c9c:	dc850513          	addi	a0,a0,-568 # 9a60 <malloc+0x1a86>
    4ca0:	00003097          	auipc	ra,0x3
    4ca4:	148080e7          	jalr	328(ra) # 7de8 <printf>
    exit(1);
    4ca8:	4505                	li	a0,1
  ...
  fd = open(".", O_RDWR);
    ...
    4cb8:	23450513          	addi	a0,a0,564 # 8ee8 <malloc+0xf0e>
  ...
  if(fd >= 0){
    ...
    4cdc:	da850513          	addi	a0,a0,-600 # 9a80 <malloc+0x1aa6>
    4ce0:	00003097          	auipc	ra,0x3
    4ce4:	108080e7          	jalr	264(ra) # 7de8 <printf>
    exit(1);
    4ce8:	4505                	li	a0,1
  ...
  fd = open(".", 0);
    ...
    4cf8:	1f450513          	addi	a0,a0,500 # 8ee8 <malloc+0xf0e>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    4d14:	52058593          	addi	a1,a1,1312 # 8230 <malloc+0x256>
    4d18:	853e                	mv	a0,a5
    ...
    4d30:	d7c50513          	addi	a0,a0,-644 # 9aa8 <malloc+0x1ace>
    4d34:	00003097          	auipc	ra,0x3
    4d38:	0b4080e7          	jalr	180(ra) # 7de8 <printf>
    exit(1);
    4d3c:	4505                	li	a0,1
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4d74:	d5050513          	addi	a0,a0,-688 # 9ac0 <malloc+0x1ae6>
    ...
    4d8c:	d4050513          	addi	a0,a0,-704 # 9ac8 <malloc+0x1aee>
    4d90:	00003097          	auipc	ra,0x3
    4d94:	058080e7          	jalr	88(ra) # 7de8 <printf>
      exit(1);
    4d98:	4505                	li	a0,1
    ...
    4da6:	d1e50513          	addi	a0,a0,-738 # 9ac0 <malloc+0x1ae6>
    ...
    4dbe:	d2650513          	addi	a0,a0,-730 # 9ae0 <malloc+0x1b06>
    4dc2:	00003097          	auipc	ra,0x3
    4dc6:	026080e7          	jalr	38(ra) # 7de8 <printf>
      exit(1);
    4dca:	4505                	li	a0,1
    ...
    4e36:	4d650513          	addi	a0,a0,1238 # 8308 <malloc+0x32e>
    ...
    4e64:	4a850513          	addi	a0,a0,1192 # 8308 <malloc+0x32e>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4e94:	ab050513          	addi	a0,a0,-1360 # 8940 <malloc+0x966>
    4e98:	00003097          	auipc	ra,0x3
    4e9c:	a88080e7          	jalr	-1400(ra) # 7920 <chdir>
    unlink("irefd");
    4ea0:	00005517          	auipc	a0,0x5
    4ea4:	c2050513          	addi	a0,a0,-992 # 9ac0 <malloc+0x1ae6>
  ...
  chdir("/");
    ...
    4ece:	78e50513          	addi	a0,a0,1934 # 8658 <malloc+0x67e>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    4f4e:	bb650513          	addi	a0,a0,-1098 # 9b00 <malloc+0x1b26>
    4f52:	00003097          	auipc	ra,0x3
    4f56:	e96080e7          	jalr	-362(ra) # 7de8 <printf>
    exit(1);
    4f5a:	4505                	li	a0,1
  ...
  if(n == N){
    ...
    4f7c:	ba050513          	addi	a0,a0,-1120 # 9b18 <malloc+0x1b3e>
    4f80:	00003097          	auipc	ra,0x3
    4f84:	e68080e7          	jalr	-408(ra) # 7de8 <printf>
    exit(1);
    4f88:	4505                	li	a0,1
  ...
  for(; n > 0; n--){
    ...
    4faa:	b9a50513          	addi	a0,a0,-1126 # 9b40 <malloc+0x1b66>
    4fae:	00003097          	auipc	ra,0x3
    4fb2:	e3a080e7          	jalr	-454(ra) # 7de8 <printf>
      exit(1);
    4fb6:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    4ff0:	b6c50513          	addi	a0,a0,-1172 # 9b58 <malloc+0x1b7e>
    4ff4:	00003097          	auipc	ra,0x3
    4ff8:	df4080e7          	jalr	-524(ra) # 7de8 <printf>
    exit(1);
    4ffc:	4505                	li	a0,1
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5038:	b3c50513          	addi	a0,a0,-1220 # 9b70 <malloc+0x1b96>
    503c:	00003097          	auipc	ra,0x3
    5040:	dac080e7          	jalr	-596(ra) # 7de8 <printf>
    exit(1);
    5044:	4505                	li	a0,1
  ...
  if(xstatus == 1){
    ...
    50da:	aba50513          	addi	a0,a0,-1350 # 9b90 <malloc+0x1bb6>
    50de:	00003097          	auipc	ra,0x3
    50e2:	d0a080e7          	jalr	-758(ra) # 7de8 <printf>
    exit(1);
    50e6:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    5134:	a8050513          	addi	a0,a0,-1408 # 9bb0 <malloc+0x1bd6>
    5138:	00003097          	auipc	ra,0x3
    513c:	cb0080e7          	jalr	-848(ra) # 7de8 <printf>
      exit(1);
    5140:	4505                	li	a0,1
    ...
    *b = 1;
    ...
    514e:	4705                	li	a4,1
    5150:	00e78023          	sb	a4,0(a5) # 40000000 <freep+0x3ffee368>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    519a:	a3a50513          	addi	a0,a0,-1478 # 9bd0 <malloc+0x1bf6>
    519e:	00003097          	auipc	ra,0x3
    51a2:	c4a080e7          	jalr	-950(ra) # 7de8 <printf>
    exit(1);
    51a6:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    51e2:	a1250513          	addi	a0,a0,-1518 # 9bf0 <malloc+0x1c16>
    51e6:	00003097          	auipc	ra,0x3
    51ea:	c02080e7          	jalr	-1022(ra) # 7de8 <printf>
    exit(1);
    51ee:	4505                	li	a0,1
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    5286:	98e50513          	addi	a0,a0,-1650 # 9c10 <malloc+0x1c36>
    528a:	00003097          	auipc	ra,0x3
    528e:	b5e080e7          	jalr	-1186(ra) # 7de8 <printf>
    exit(1);
    5292:	4505                	li	a0,1
  ...
  lastaddr = (char*) (BIG-1);
    ...
    52da:	17fd                	addi	a5,a5,-1 # 63fffff <freep+0x63ee367>
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    531a:	94250513          	addi	a0,a0,-1726 # 9c58 <malloc+0x1c7e>
    531e:	00003097          	auipc	ra,0x3
    5322:	aca080e7          	jalr	-1334(ra) # 7de8 <printf>
    exit(1);
    5326:	4505                	li	a0,1
  ...
  if(c != a - PGSIZE){
    ...
    535e:	91e50513          	addi	a0,a0,-1762 # 9c78 <malloc+0x1c9e>
    5362:	00003097          	auipc	ra,0x3
    5366:	a86080e7          	jalr	-1402(ra) # 7de8 <printf>
    exit(1);
    536a:	4505                	li	a0,1
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    53c4:	8f850513          	addi	a0,a0,-1800 # 9cb8 <malloc+0x1cde>
    53c8:	00003097          	auipc	ra,0x3
    53cc:	a20080e7          	jalr	-1504(ra) # 7de8 <printf>
    exit(1);
    53d0:	4505                	li	a0,1
  ...
  if(*lastaddr == 99){
    ...
    53f4:	8f850513          	addi	a0,a0,-1800 # 9ce8 <malloc+0x1d0e>
    53f8:	00003097          	auipc	ra,0x3
    53fc:	9f0080e7          	jalr	-1552(ra) # 7de8 <printf>
    exit(1);
    5400:	4505                	li	a0,1
  ...
  if(c != a){
    ...
    5456:	8ce50513          	addi	a0,a0,-1842 # 9d20 <malloc+0x1d46>
    545a:	00003097          	auipc	ra,0x3
    545e:	98e080e7          	jalr	-1650(ra) # 7de8 <printf>
    exit(1);
    5462:	4505                	li	a0,1
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    54ac:	0b850513          	addi	a0,a0,184 # 8560 <malloc+0x586>
    54b0:	00003097          	auipc	ra,0x3
    54b4:	938080e7          	jalr	-1736(ra) # 7de8 <printf>
      exit(1);
    54b8:	4505                	li	a0,1
    ...
    54e2:	86a50513          	addi	a0,a0,-1942 # 9d48 <malloc+0x1d6e>
    54e6:	00003097          	auipc	ra,0x3
    54ea:	902080e7          	jalr	-1790(ra) # 7de8 <printf>
      exit(1);
    54ee:	4505                	li	a0,1
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    5522:	35078793          	addi	a5,a5,848 # c350 <buf+0xee0>
    ...
    5536:	47f78793          	addi	a5,a5,1151 # 1003d47f <freep+0x1002b7e7>
...
MAXVAplus(char *s)
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    5580:	fe450513          	addi	a0,a0,-28 # 8560 <malloc+0x586>
    5584:	00003097          	auipc	ra,0x3
    5588:	864080e7          	jalr	-1948(ra) # 7de8 <printf>
      exit(1);
    558c:	4505                	li	a0,1
    ...
    55a8:	00f70023          	sb	a5,0(a4) # 6400000 <freep+0x63ee368>
      printf("%s: oops wrote %x\n", s, a);
    55ac:	fe043783          	ld	a5,-32(s0)
    55b0:	863e                	mv	a2,a5
    55b2:	fc843583          	ld	a1,-56(s0)
    55b6:	00004517          	auipc	a0,0x4
    55ba:	7b250513          	addi	a0,a0,1970 # 9d68 <malloc+0x1d8e>
    55be:	00003097          	auipc	ra,0x3
    55c2:	82a080e7          	jalr	-2006(ra) # 7de8 <printf>
      exit(1);
    55c6:	4505                	li	a0,1
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5636:	3c650513          	addi	a0,a0,966 # 89f8 <malloc+0xa1e>
    563a:	00002097          	auipc	ra,0x2
    563e:	7ae080e7          	jalr	1966(ra) # 7de8 <printf>
    exit(1);
    5642:	4505                	li	a0,1
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    56aa:	b8a58593          	addi	a1,a1,-1142 # 8230 <malloc+0x256>
    56ae:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5780:	60450513          	addi	a0,a0,1540 # 9d80 <malloc+0x1da6>
    5784:	00002097          	auipc	ra,0x2
    5788:	664080e7          	jalr	1636(ra) # 7de8 <printf>
    exit(1);
    578c:	4505                	li	a0,1
  ...
  if(pid < 0){
    ...
    57b6:	dae50513          	addi	a0,a0,-594 # 8560 <malloc+0x586>
    57ba:	00002097          	auipc	ra,0x2
    57be:	62e080e7          	jalr	1582(ra) # 7de8 <printf>
    exit(1);
    57c2:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    583e:	56650513          	addi	a0,a0,1382 # 9da0 <malloc+0x1dc6>
    5842:	00002097          	auipc	ra,0x2
    5846:	5a6080e7          	jalr	1446(ra) # 7de8 <printf>
    exit(1);
    584a:	4505                	li	a0,1
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    58b0:	52450513          	addi	a0,a0,1316 # 9dd0 <malloc+0x1df6>
  ...
  unlink("sbrk");
    ...
    58c6:	50e50513          	addi	a0,a0,1294 # 9dd0 <malloc+0x1df6>
  ...
  if(fd < 0)  {
    ...
    58e4:	4f850513          	addi	a0,a0,1272 # 9dd8 <malloc+0x1dfe>
    58e8:	00002097          	auipc	ra,0x2
    58ec:	500080e7          	jalr	1280(ra) # 7de8 <printf>
    exit(1);
    58f0:	4505                	li	a0,1
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5926:	4ce50513          	addi	a0,a0,1230 # 9df0 <malloc+0x1e16>
    592a:	00002097          	auipc	ra,0x2
    592e:	4be080e7          	jalr	1214(ra) # 7de8 <printf>
    exit(1);
    5932:	4505                	li	a0,1
  ...
  if(pipe((int *) a) != 0){
    ...
    5970:	08c50513          	addi	a0,a0,140 # 89f8 <malloc+0xa1e>
    5974:	00002097          	auipc	ra,0x2
    5978:	474080e7          	jalr	1140(ra) # 7de8 <printf>
    exit(1);
    597c:	4505                	li	a0,1
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    59b4:	45850513          	addi	a0,a0,1112 # 9e08 <malloc+0x1e2e>
    ...
    59d2:	44a50513          	addi	a0,a0,1098 # 9e18 <malloc+0x1e3e>
    59d6:	00002097          	auipc	ra,0x2
    59da:	412080e7          	jalr	1042(ra) # 7de8 <printf>
      exit(1);
    59de:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    5a22:	00009717          	auipc	a4,0x9
    5a26:	a4e70713          	addi	a4,a4,-1458 # e470 <uninit>
    ...
    5a3e:	3fe50513          	addi	a0,a0,1022 # 9e38 <malloc+0x1e5e>
    5a42:	00002097          	auipc	ra,0x2
    5a46:	3a6080e7          	jalr	934(ra) # 7de8 <printf>
      exit(1);
    5a4a:	4505                	li	a0,1
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    5a8a:	3ca50513          	addi	a0,a0,970 # 9e50 <malloc+0x1e76>
  ...
  if(pid == 0){
    ...
    5ab2:	0000c717          	auipc	a4,0xc
    5ab6:	0d670713          	addi	a4,a4,214 # 11b88 <args.1>
    5aba:	fec42783          	lw	a5,-20(s0)
    5abe:	078e                	slli	a5,a5,0x3
    5ac0:	97ba                	add	a5,a5,a4
    5ac2:	00004717          	auipc	a4,0x4
    5ac6:	39e70713          	addi	a4,a4,926 # 9e60 <malloc+0x1e86>
    ...
    args[MAXARG-1] = 0;
    5ae4:	0000c797          	auipc	a5,0xc
    5ae8:	0a478793          	addi	a5,a5,164 # 11b88 <args.1>
    5aec:	0e07bc23          	sd	zero,248(a5)
    exec("echo", args);
    5af0:	0000c597          	auipc	a1,0xc
    5af4:	09858593          	addi	a1,a1,152 # 11b88 <args.1>
    5af8:	00003517          	auipc	a0,0x3
    5afc:	84850513          	addi	a0,a0,-1976 # 8340 <malloc+0x366>
    5b00:	00002097          	auipc	ra,0x2
    5b04:	de8080e7          	jalr	-536(ra) # 78e8 <exec>
    fd = open("bigarg-ok", O_CREATE);
    5b08:	20000593          	li	a1,512
    5b0c:	00004517          	auipc	a0,0x4
    5b10:	34450513          	addi	a0,a0,836 # 9e50 <malloc+0x1e76>
    ...
    5b4c:	3f850513          	addi	a0,a0,1016 # 9f40 <malloc+0x1f66>
    5b50:	00002097          	auipc	ra,0x2
    5b54:	298080e7          	jalr	664(ra) # 7de8 <printf>
    exit(1);
    5b58:	4505                	li	a0,1
  ...
  fd = open("bigarg-ok", 0);
    ...
    5b8a:	2ca50513          	addi	a0,a0,714 # 9e50 <malloc+0x1e76>
  ...
  if(fd < 0){
    ...
    5bae:	3b650513          	addi	a0,a0,950 # 9f60 <malloc+0x1f86>
    5bb2:	00002097          	auipc	ra,0x2
    5bb6:	236080e7          	jalr	566(ra) # 7de8 <printf>
    exit(1);
    5bba:	4505                	li	a0,1
...
fsfull()
{
  ...
  printf("fsfull test\n");
    ...
    5bec:	39850513          	addi	a0,a0,920 # 9f80 <malloc+0x1fa6>
    5bf0:	00002097          	auipc	ra,0x2
    5bf4:	1f8080e7          	jalr	504(ra) # 7de8 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ca6:	2ee50513          	addi	a0,a0,750 # 9f90 <malloc+0x1fb6>
    5caa:	00002097          	auipc	ra,0x2
    5cae:	13e080e7          	jalr	318(ra) # 7de8 <printf>
    ...
    5cde:	2c650513          	addi	a0,a0,710 # 9fa0 <malloc+0x1fc6>
    5ce2:	00002097          	auipc	ra,0x2
    5ce6:	106080e7          	jalr	262(ra) # 7de8 <printf>
      break;
    ...
    5cf8:	00005597          	auipc	a1,0x5
    5cfc:	77858593          	addi	a1,a1,1912 # b470 <buf>
    5d00:	853e                	mv	a0,a5
    ...
    5d48:	26c50513          	addi	a0,a0,620 # 9fb0 <malloc+0x1fd6>
    5d4c:	00002097          	auipc	ra,0x2
    5d50:	09c080e7          	jalr	156(ra) # 7de8 <printf>
    close(fd);
  ...
  printf("fsfull test finished\n");
    ...
    5e40:	18450513          	addi	a0,a0,388 # 9fc0 <malloc+0x1fe6>
    5e44:	00002097          	auipc	ra,0x2
    5e48:	fa4080e7          	jalr	-92(ra) # 7de8 <printf>
}
    5e4c:	0001                	nop
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    ...
    5e68:	17450513          	addi	a0,a0,372 # 9fd8 <malloc+0x1ffe>
  ...
  if (fd < 0) {
    ...
    5e8c:	6f050513          	addi	a0,a0,1776 # 8578 <malloc+0x59e>
    5e90:	00002097          	auipc	ra,0x2
    5e94:	f58080e7          	jalr	-168(ra) # 7de8 <printf>
    exit(1);
    5e98:	4505                	li	a0,1
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    5f1c:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <freep+0xfffffffffffed368>
    5f20:	2781                	sext.w	a5,a5
    5f22:	863e                	mv	a2,a5
    5f24:	fc843583          	ld	a1,-56(s0)
    5f28:	00004517          	auipc	a0,0x4
    5f2c:	0b850513          	addi	a0,a0,184 # 9fe0 <malloc+0x2006>
    5f30:	00002097          	auipc	ra,0x2
    5f34:	eb8080e7          	jalr	-328(ra) # 7de8 <printf>
    exit(1);
    5f38:	4505                	li	a0,1
    ...
    5f54:	61050513          	addi	a0,a0,1552 # 8560 <malloc+0x586>
    5f58:	00002097          	auipc	ra,0x2
    5f5c:	e90080e7          	jalr	-368(ra) # 7de8 <printf>
    exit(1);
    5f60:	4505                	li	a0,1
...
textwrite(char *s)
{
  ...
  if(pid == 0) {
    ...
    *addr = 10;
    ...
    5fe6:	57e50513          	addi	a0,a0,1406 # 8560 <malloc+0x586>
    5fea:	00002097          	auipc	ra,0x2
    5fee:	dfe080e7          	jalr	-514(ra) # 7de8 <printf>
    exit(1);
    5ff2:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec(big, argv);
    603e:	00005797          	auipc	a5,0x5
    6042:	fc278793          	addi	a5,a5,-62 # b000 <big>
  ...
  pipe(big);
    6058:	00005797          	auipc	a5,0x5
    605c:	fa878793          	addi	a5,a5,-88 # b000 <big>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    609e:	29650513          	addi	a0,a0,662 # 8330 <malloc+0x356>
    60a2:	00002097          	auipc	ra,0x2
    60a6:	d46080e7          	jalr	-698(ra) # 7de8 <printf>
    exit(1);
    60aa:	4505                	li	a0,1
  ...
  if(pid < 0){
    ...
    6110:	22450513          	addi	a0,a0,548 # 8330 <malloc+0x356>
    6114:	00002097          	auipc	ra,0x2
    6118:	cd4080e7          	jalr	-812(ra) # 7de8 <printf>
    exit(1);
    611c:	4505                	li	a0,1
  ...
  if(pid < 0){
    ...
    6186:	1ae50513          	addi	a0,a0,430 # 8330 <malloc+0x356>
    618a:	00002097          	auipc	ra,0x2
    618e:	c5e080e7          	jalr	-930(ra) # 7de8 <printf>
    exit(1);
    6192:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    61b4:	8007071b          	addiw	a4,a4,-2048 # a800 <malloc+0x2826>
...
sbrk8000(char *s)
{
  ...
  sbrk(0x80000004);
    ...
    632c:	00478513          	addi	a0,a5,4 # ffffffff80000004 <freep+0xffffffff7ffee36c>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    6396:	fae50513          	addi	a0,a0,-82 # 8340 <malloc+0x366>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    63b6:	34f78793          	addi	a5,a5,847 # c34f <buf+0xedf>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    63d8:	f2450513          	addi	a0,a0,-220 # a2f8 <malloc+0x231e>
  ...
  fd = open("bd", O_CREATE);
    ...
    63ec:	f1050513          	addi	a0,a0,-240 # a2f8 <malloc+0x231e>
  ...
  if(fd < 0){
    ...
    6410:	ef450513          	addi	a0,a0,-268 # a300 <malloc+0x2326>
    6414:	00002097          	auipc	ra,0x2
    6418:	9d4080e7          	jalr	-1580(ra) # 7de8 <printf>
    exit(1);
    641c:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    649e:	e5e50513          	addi	a0,a0,-418 # a2f8 <malloc+0x231e>
    ...
    64bc:	e6850513          	addi	a0,a0,-408 # a320 <malloc+0x2346>
    64c0:	00002097          	auipc	ra,0x2
    64c4:	928080e7          	jalr	-1752(ra) # 7de8 <printf>
      exit(1);
    64c8:	4505                	li	a0,1
  ...
  unlink("bd");
    ...
    64f0:	e0c50513          	addi	a0,a0,-500 # a2f8 <malloc+0x231e>
  ...
  for(i = 0; i < N; i++){
    ...
    6576:	dce50513          	addi	a0,a0,-562 # a340 <malloc+0x2366>
    657a:	00002097          	auipc	ra,0x2
    657e:	86e080e7          	jalr	-1938(ra) # 7de8 <printf>
      exit(1);
    6582:	4505                	li	a0,1
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    65ec:	d4850513          	addi	a0,a0,-696 # 8330 <malloc+0x356>
    65f0:	00001097          	auipc	ra,0x1
    65f4:	7f8080e7          	jalr	2040(ra) # 7de8 <printf>
      exit(1);
    65f8:	4505                	li	a0,1
    ...
    6676:	cee50513          	addi	a0,a0,-786 # a360 <malloc+0x2386>
    667a:	00001097          	auipc	ra,0x1
    667e:	76e080e7          	jalr	1902(ra) # 7de8 <printf>
            exit(1);
    6682:	4505                	li	a0,1
    ...
    669a:	863a                	mv	a2,a4
    669c:	00005597          	auipc	a1,0x5
    66a0:	dd458593          	addi	a1,a1,-556 # b470 <buf>
    66a4:	853e                	mv	a0,a5
    ...
    66da:	e9250513          	addi	a0,a0,-366 # 9568 <malloc+0x158e>
    66de:	00001097          	auipc	ra,0x1
    66e2:	70a080e7          	jalr	1802(ra) # 7de8 <printf>
            exit(1);
    66e6:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
    ...
    67e2:	b9a50513          	addi	a0,a0,-1126 # a378 <malloc+0x239e>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    67fc:	b8050513          	addi	a0,a0,-1152 # a378 <malloc+0x239e>
    ...
    681c:	b6850513          	addi	a0,a0,-1176 # a380 <malloc+0x23a6>
    6820:	00001097          	auipc	ra,0x1
    6824:	5c8080e7          	jalr	1480(ra) # 7de8 <printf>
      exit(1);
    6828:	4505                	li	a0,1
    ...
    685a:	b2250513          	addi	a0,a0,-1246 # a378 <malloc+0x239e>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    688a:	af250513          	addi	a0,a0,-1294 # a378 <malloc+0x239e>
  ...
  if(fd < 0){
    ...
    68aa:	ada50513          	addi	a0,a0,-1318 # a380 <malloc+0x23a6>
    68ae:	00001097          	auipc	ra,0x1
    68b2:	53a080e7          	jalr	1338(ra) # 7de8 <printf>
    exit(1);
    68b6:	4505                	li	a0,1
  ...
  if(write(fd, "x", 1) != 1){
    ...
    68ca:	96a58593          	addi	a1,a1,-1686 # 8230 <malloc+0x256>
    68ce:	853e                	mv	a0,a5
    ...
    68e6:	ab650513          	addi	a0,a0,-1354 # a398 <malloc+0x23be>
    68ea:	00001097          	auipc	ra,0x1
    68ee:	4fe080e7          	jalr	1278(ra) # 7de8 <printf>
    exit(1);
    68f2:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    690e:	a6e50513          	addi	a0,a0,-1426 # a378 <malloc+0x239e>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    6952:	9e250513          	addi	a0,a0,-1566 # 8330 <malloc+0x356>
    6956:	00001097          	auipc	ra,0x1
    695a:	492080e7          	jalr	1170(ra) # 7de8 <printf>
      exit(1);
    695e:	4505                	li	a0,1
    ...
    69da:	96a78793          	addi	a5,a5,-1686 # 8340 <malloc+0x366>
    69de:	fcf43023          	sd	a5,-64(s0)
    69e2:	00002797          	auipc	a5,0x2
    69e6:	84e78793          	addi	a5,a5,-1970 # 8230 <malloc+0x256>
    ...
    69fc:	94850513          	addi	a0,a0,-1720 # 8340 <malloc+0x366>
...
diskfull(char *s)
{
  ...
  unlink("diskfulldir");
    ...
    6a5a:	95250513          	addi	a0,a0,-1710 # a3a8 <malloc+0x23ce>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    6ada:	8e250513          	addi	a0,a0,-1822 # a3b8 <malloc+0x23de>
    6ade:	00001097          	auipc	ra,0x1
    6ae2:	30a080e7          	jalr	778(ra) # 7de8 <printf>
      done = 1;
    6ae6:	4785                	li	a5,1
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    6c36:	77650513          	addi	a0,a0,1910 # a3a8 <malloc+0x23ce>
    ...
    6c4a:	79250513          	addi	a0,a0,1938 # a3d8 <malloc+0x23fe>
    6c4e:	00001097          	auipc	ra,0x1
    6c52:	19a080e7          	jalr	410(ra) # 7de8 <printf>

  unlink("diskfulldir");
    6c56:	00003517          	auipc	a0,0x3
    6c5a:	75250513          	addi	a0,a0,1874 # a3a8 <malloc+0x23ce>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    6ef4:	56850513          	addi	a0,a0,1384 # a458 <malloc+0x247e>
    6ef8:	00001097          	auipc	ra,0x1
    6efc:	ef0080e7          	jalr	-272(ra) # 7de8 <printf>
  if((pid = fork()) < 0) {
    ...
    6f1c:	55050513          	addi	a0,a0,1360 # a468 <malloc+0x248e>
    6f20:	00001097          	auipc	ra,0x1
    6f24:	ec8080e7          	jalr	-312(ra) # 7de8 <printf>
    exit(1);
    6f28:	4505                	li	a0,1
  ...
  if(pid == 0) {
    ...
    6f66:	51e50513          	addi	a0,a0,1310 # a480 <malloc+0x24a6>
    6f6a:	00001097          	auipc	ra,0x1
    6f6e:	e7e080e7          	jalr	-386(ra) # 7de8 <printf>
    6f72:	a809                	j	6f84 <run+0xa8>
    else
      printf("OK\n");
    6f74:	00003517          	auipc	a0,0x3
    6f78:	51450513          	addi	a0,a0,1300 # a488 <malloc+0x24ae>
    6f7c:	00001097          	auipc	ra,0x1
    6f80:	e6c080e7          	jalr	-404(ra) # 7de8 <printf>
    return xstatus == 0;
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    6ff4:	4a050513          	addi	a0,a0,1184 # a490 <malloc+0x24b6>
    6ff8:	00001097          	auipc	ra,0x1
    6ffc:	df0080e7          	jalr	-528(ra) # 7de8 <printf>
        return 1;
    7000:	4785                	li	a5,1
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    7042:	46a50513          	addi	a0,a0,1130 # a4a8 <malloc+0x24ce>
    7046:	00001097          	auipc	ra,0x1
    704a:	da2080e7          	jalr	-606(ra) # 7de8 <printf>
    exit(1);
    704e:	4505                	li	a0,1
  ...
  if(pid < 0){
    ...
    7074:	45850513          	addi	a0,a0,1112 # a4c8 <malloc+0x24ee>
    7078:	00001097          	auipc	ra,0x1
    707c:	d70080e7          	jalr	-656(ra) # 7de8 <printf>
    exit(1);
    7080:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    70d6:	15e58593          	addi	a1,a1,350 # 8230 <malloc+0x256>
    70da:	853e                	mv	a0,a5
    ...
    70f2:	3fa50513          	addi	a0,a0,1018 # a4e8 <malloc+0x250e>
    70f6:	00001097          	auipc	ra,0x1
    70fa:	cf2080e7          	jalr	-782(ra) # 7de8 <printf>
        exit(1);
    70fe:	4505                	li	a0,1
  ...
  while(1){
    ...
    7150:	3bc50513          	addi	a0,a0,956 # a508 <malloc+0x252e>
    7154:	00001097          	auipc	ra,0x1
    7158:	c94080e7          	jalr	-876(ra) # 7de8 <printf>
      exit(1);
    715c:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    71c0:	36c50513          	addi	a0,a0,876 # a528 <malloc+0x254e>
    71c4:	00001097          	auipc	ra,0x1
    71c8:	c24080e7          	jalr	-988(ra) # 7de8 <printf>
    int free0 = countfree();
    ...
    71e6:	e2e50513          	addi	a0,a0,-466 # b010 <quicktests>
    ...
    721a:	32a50513          	addi	a0,a0,810 # a540 <malloc+0x2566>
    721e:	00001097          	auipc	ra,0x1
    7222:	bca080e7          	jalr	-1078(ra) # 7de8 <printf>
      if (runtests(slowtests, justone)) {
    7226:	fd043583          	ld	a1,-48(s0)
    722a:	00004517          	auipc	a0,0x4
    722e:	1b650513          	addi	a0,a0,438 # b3e0 <slowtests>
    ...
    7280:	2e450513          	addi	a0,a0,740 # a560 <malloc+0x2586>
    7284:	00001097          	auipc	ra,0x1
    7288:	b64080e7          	jalr	-1180(ra) # 7de8 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    72ea:	2aa58593          	addi	a1,a1,682 # a590 <malloc+0x25b6>
    72ee:	853e                	mv	a0,a5
    ...
    731e:	27e58593          	addi	a1,a1,638 # a598 <malloc+0x25be>
    7322:	853e                	mv	a0,a5
    ...
    7352:	25258593          	addi	a1,a1,594 # a5a0 <malloc+0x25c6>
    7356:	853e                	mv	a0,a5
    ...
    73ae:	1fe50513          	addi	a0,a0,510 # a5a8 <malloc+0x25ce>
    73b2:	00001097          	auipc	ra,0x1
    73b6:	a36080e7          	jalr	-1482(ra) # 7de8 <printf>
    exit(1);
    73ba:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    73ee:	1ee50513          	addi	a0,a0,494 # a5d8 <malloc+0x25fe>
    73f2:	00001097          	auipc	ra,0x1
    73f6:	9f6080e7          	jalr	-1546(ra) # 7de8 <printf>
  exit(0);
    73fa:	4501                	li	a0,0
...
putc(int fd, char c)
{
    7960:	1101                	addi	sp,sp,-32
    7962:	ec06                	sd	ra,24(sp)
    7964:	e822                	sd	s0,16(sp)
    7966:	1000                	addi	s0,sp,32
    7968:	87aa                	mv	a5,a0
    796a:	872e                	mv	a4,a1
    796c:	fef42623          	sw	a5,-20(s0)
    7970:	87ba                	mv	a5,a4
    7972:	fef405a3          	sb	a5,-21(s0)
  write(fd, &c, 1);
    7976:	feb40713          	addi	a4,s0,-21
    797a:	fec42783          	lw	a5,-20(s0)
    797e:	4605                	li	a2,1
    7980:	85ba                	mv	a1,a4
    7982:	853e                	mv	a0,a5
    7984:	00000097          	auipc	ra,0x0
    7988:	f4c080e7          	jalr	-180(ra) # 78d0 <write>
}
    798c:	0001                	nop
    798e:	60e2                	ld	ra,24(sp)
    7990:	6442                	ld	s0,16(sp)
    7992:	6105                	addi	sp,sp,32
    7994:	8082                	ret

0000000000007996 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    7996:	7139                	addi	sp,sp,-64
    7998:	fc06                	sd	ra,56(sp)
    799a:	f822                	sd	s0,48(sp)
    799c:	0080                	addi	s0,sp,64
    799e:	87aa                	mv	a5,a0
    79a0:	8736                	mv	a4,a3
    79a2:	fcf42623          	sw	a5,-52(s0)
    79a6:	87ae                	mv	a5,a1
    79a8:	fcf42423          	sw	a5,-56(s0)
    79ac:	87b2                	mv	a5,a2
    79ae:	fcf42223          	sw	a5,-60(s0)
    79b2:	87ba                	mv	a5,a4
    79b4:	fcf42023          	sw	a5,-64(s0)
  char buf[16];
  int i, neg;
  uint x;

  neg = 0;
    79b8:	fe042423          	sw	zero,-24(s0)
  if(sgn && xx < 0){
    79bc:	fc042783          	lw	a5,-64(s0)
    79c0:	2781                	sext.w	a5,a5
    79c2:	c38d                	beqz	a5,79e4 <printint+0x4e>
    79c4:	fc842783          	lw	a5,-56(s0)
    79c8:	2781                	sext.w	a5,a5
    79ca:	0007dd63          	bgez	a5,79e4 <printint+0x4e>
    neg = 1;
    79ce:	4785                	li	a5,1
    79d0:	fef42423          	sw	a5,-24(s0)
    x = -xx;
    79d4:	fc842783          	lw	a5,-56(s0)
    79d8:	40f007bb          	negw	a5,a5
    79dc:	2781                	sext.w	a5,a5
    79de:	fef42223          	sw	a5,-28(s0)
    79e2:	a029                	j	79ec <printint+0x56>
  } else {
    x = xx;
    79e4:	fc842783          	lw	a5,-56(s0)
    79e8:	fef42223          	sw	a5,-28(s0)
  }

  i = 0;
    79ec:	fe042623          	sw	zero,-20(s0)
  do{
    buf[i++] = digits[x % base];
    79f0:	fc442783          	lw	a5,-60(s0)
    79f4:	fe442703          	lw	a4,-28(s0)
    79f8:	02f777bb          	remuw	a5,a4,a5
    79fc:	0007861b          	sext.w	a2,a5
    7a00:	fec42783          	lw	a5,-20(s0)
    7a04:	0017871b          	addiw	a4,a5,1
    7a08:	fee42623          	sw	a4,-20(s0)
    7a0c:	00004697          	auipc	a3,0x4
    7a10:	a4468693          	addi	a3,a3,-1468 # b450 <digits>
    7a14:	02061713          	slli	a4,a2,0x20
    7a18:	9301                	srli	a4,a4,0x20
    7a1a:	9736                	add	a4,a4,a3
    7a1c:	00074703          	lbu	a4,0(a4)
    7a20:	17c1                	addi	a5,a5,-16
    7a22:	97a2                	add	a5,a5,s0
    7a24:	fee78023          	sb	a4,-32(a5)
  }while((x /= base) != 0);
    7a28:	fc442783          	lw	a5,-60(s0)
    7a2c:	fe442703          	lw	a4,-28(s0)
    7a30:	02f757bb          	divuw	a5,a4,a5
    7a34:	fef42223          	sw	a5,-28(s0)
    7a38:	fe442783          	lw	a5,-28(s0)
    7a3c:	2781                	sext.w	a5,a5
    7a3e:	fbcd                	bnez	a5,79f0 <printint+0x5a>
  if(neg)
    7a40:	fe842783          	lw	a5,-24(s0)
    7a44:	2781                	sext.w	a5,a5
    7a46:	cf85                	beqz	a5,7a7e <printint+0xe8>
    buf[i++] = '-';
    7a48:	fec42783          	lw	a5,-20(s0)
    7a4c:	0017871b          	addiw	a4,a5,1
    7a50:	fee42623          	sw	a4,-20(s0)
    7a54:	17c1                	addi	a5,a5,-16
    7a56:	97a2                	add	a5,a5,s0
    7a58:	02d00713          	li	a4,45
    7a5c:	fee78023          	sb	a4,-32(a5)

  while(--i >= 0)
    7a60:	a839                	j	7a7e <printint+0xe8>
    putc(fd, buf[i]);
    7a62:	fec42783          	lw	a5,-20(s0)
    7a66:	17c1                	addi	a5,a5,-16
    7a68:	97a2                	add	a5,a5,s0
    7a6a:	fe07c703          	lbu	a4,-32(a5)
    7a6e:	fcc42783          	lw	a5,-52(s0)
    7a72:	85ba                	mv	a1,a4
    7a74:	853e                	mv	a0,a5
    7a76:	00000097          	auipc	ra,0x0
    7a7a:	eea080e7          	jalr	-278(ra) # 7960 <putc>
  while(--i >= 0)
    7a7e:	fec42783          	lw	a5,-20(s0)
    7a82:	37fd                	addiw	a5,a5,-1
    7a84:	fef42623          	sw	a5,-20(s0)
    7a88:	fec42783          	lw	a5,-20(s0)
    7a8c:	2781                	sext.w	a5,a5
    7a8e:	fc07dae3          	bgez	a5,7a62 <printint+0xcc>
}
    7a92:	0001                	nop
    7a94:	0001                	nop
    7a96:	70e2                	ld	ra,56(sp)
    7a98:	7442                	ld	s0,48(sp)
    7a9a:	6121                	addi	sp,sp,64
    7a9c:	8082                	ret

0000000000007a9e <printptr>:

static void
printptr(int fd, uint64 x) {
    7a9e:	7179                	addi	sp,sp,-48
    7aa0:	f406                	sd	ra,40(sp)
    7aa2:	f022                	sd	s0,32(sp)
    7aa4:	1800                	addi	s0,sp,48
    7aa6:	87aa                	mv	a5,a0
    7aa8:	fcb43823          	sd	a1,-48(s0)
    7aac:	fcf42e23          	sw	a5,-36(s0)
  int i;
  putc(fd, '0');
    7ab0:	fdc42783          	lw	a5,-36(s0)
    7ab4:	03000593          	li	a1,48
    7ab8:	853e                	mv	a0,a5
    7aba:	00000097          	auipc	ra,0x0
    7abe:	ea6080e7          	jalr	-346(ra) # 7960 <putc>
  putc(fd, 'x');
    7ac2:	fdc42783          	lw	a5,-36(s0)
    7ac6:	07800593          	li	a1,120
    7aca:	853e                	mv	a0,a5
    7acc:	00000097          	auipc	ra,0x0
    7ad0:	e94080e7          	jalr	-364(ra) # 7960 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    7ad4:	fe042623          	sw	zero,-20(s0)
    7ad8:	a82d                	j	7b12 <printptr+0x74>
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    7ada:	fd043783          	ld	a5,-48(s0)
    7ade:	93f1                	srli	a5,a5,0x3c
    7ae0:	00004717          	auipc	a4,0x4
    7ae4:	97070713          	addi	a4,a4,-1680 # b450 <digits>
    7ae8:	97ba                	add	a5,a5,a4
    7aea:	0007c703          	lbu	a4,0(a5)
    7aee:	fdc42783          	lw	a5,-36(s0)
    7af2:	85ba                	mv	a1,a4
    7af4:	853e                	mv	a0,a5
    7af6:	00000097          	auipc	ra,0x0
    7afa:	e6a080e7          	jalr	-406(ra) # 7960 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    7afe:	fec42783          	lw	a5,-20(s0)
    7b02:	2785                	addiw	a5,a5,1
    7b04:	fef42623          	sw	a5,-20(s0)
    7b08:	fd043783          	ld	a5,-48(s0)
    7b0c:	0792                	slli	a5,a5,0x4
    7b0e:	fcf43823          	sd	a5,-48(s0)
    7b12:	fec42783          	lw	a5,-20(s0)
    7b16:	873e                	mv	a4,a5
    7b18:	47bd                	li	a5,15
    7b1a:	fce7f0e3          	bgeu	a5,a4,7ada <printptr+0x3c>
}
    7b1e:	0001                	nop
    7b20:	0001                	nop
    7b22:	70a2                	ld	ra,40(sp)
    7b24:	7402                	ld	s0,32(sp)
    7b26:	6145                	addi	sp,sp,48
    7b28:	8082                	ret

0000000000007b2a <vprintf>:

// Print to the given fd. Only understands %d, %x, %p, %s.
void
vprintf(int fd, const char *fmt, va_list ap)
{
    7b2a:	715d                	addi	sp,sp,-80
    7b2c:	e486                	sd	ra,72(sp)
    7b2e:	e0a2                	sd	s0,64(sp)
    7b30:	0880                	addi	s0,sp,80
    7b32:	87aa                	mv	a5,a0
    7b34:	fcb43023          	sd	a1,-64(s0)
    7b38:	fac43c23          	sd	a2,-72(s0)
    7b3c:	fcf42623          	sw	a5,-52(s0)
  char *s;
  int c, i, state;

  state = 0;
    7b40:	fe042023          	sw	zero,-32(s0)
  for(i = 0; fmt[i]; i++){
    7b44:	fe042223          	sw	zero,-28(s0)
    7b48:	a42d                	j	7d72 <vprintf+0x248>
    c = fmt[i] & 0xff;
    7b4a:	fe442783          	lw	a5,-28(s0)
    7b4e:	fc043703          	ld	a4,-64(s0)
    7b52:	97ba                	add	a5,a5,a4
    7b54:	0007c783          	lbu	a5,0(a5)
    7b58:	fcf42e23          	sw	a5,-36(s0)
    if(state == 0){
    7b5c:	fe042783          	lw	a5,-32(s0)
    7b60:	2781                	sext.w	a5,a5
    7b62:	eb9d                	bnez	a5,7b98 <vprintf+0x6e>
      if(c == '%'){
    7b64:	fdc42783          	lw	a5,-36(s0)
    7b68:	0007871b          	sext.w	a4,a5
    7b6c:	02500793          	li	a5,37
    7b70:	00f71763          	bne	a4,a5,7b7e <vprintf+0x54>
        state = '%';
    7b74:	02500793          	li	a5,37
    7b78:	fef42023          	sw	a5,-32(s0)
    7b7c:	a2f5                	j	7d68 <vprintf+0x23e>
      } else {
        putc(fd, c);
    7b7e:	fdc42783          	lw	a5,-36(s0)
    7b82:	0ff7f713          	zext.b	a4,a5
    7b86:	fcc42783          	lw	a5,-52(s0)
    7b8a:	85ba                	mv	a1,a4
    7b8c:	853e                	mv	a0,a5
    7b8e:	00000097          	auipc	ra,0x0
    7b92:	dd2080e7          	jalr	-558(ra) # 7960 <putc>
    7b96:	aac9                	j	7d68 <vprintf+0x23e>
      }
    } else if(state == '%'){
    7b98:	fe042783          	lw	a5,-32(s0)
    7b9c:	0007871b          	sext.w	a4,a5
    7ba0:	02500793          	li	a5,37
    7ba4:	1cf71263          	bne	a4,a5,7d68 <vprintf+0x23e>
      if(c == 'd'){
    7ba8:	fdc42783          	lw	a5,-36(s0)
    7bac:	0007871b          	sext.w	a4,a5
    7bb0:	06400793          	li	a5,100
    7bb4:	02f71463          	bne	a4,a5,7bdc <vprintf+0xb2>
    ...
    7bd6:	dc4080e7          	jalr	-572(ra) # 7996 <printint>
    7bda:	a269                	j	7d64 <vprintf+0x23a>
      } else if(c == 'l') {
    7bdc:	fdc42783          	lw	a5,-36(s0)
    7be0:	0007871b          	sext.w	a4,a5
    7be4:	06c00793          	li	a5,108
    7be8:	02f71663          	bne	a4,a5,7c14 <vprintf+0xea>
        printint(fd, va_arg(ap, uint64), 10, 0);
    7bec:	fb843783          	ld	a5,-72(s0)
    7bf0:	00878713          	addi	a4,a5,8
    7bf4:	fae43c23          	sd	a4,-72(s0)
    7bf8:	639c                	ld	a5,0(a5)
    7bfa:	0007871b          	sext.w	a4,a5
    7bfe:	fcc42783          	lw	a5,-52(s0)
    7c02:	4681                	li	a3,0
    7c04:	4629                	li	a2,10
    7c06:	85ba                	mv	a1,a4
    7c08:	853e                	mv	a0,a5
    7c0a:	00000097          	auipc	ra,0x0
    7c0e:	d8c080e7          	jalr	-628(ra) # 7996 <printint>
    7c12:	aa89                	j	7d64 <vprintf+0x23a>
      } else if(c == 'x') {
    7c14:	fdc42783          	lw	a5,-36(s0)
    7c18:	0007871b          	sext.w	a4,a5
    7c1c:	07800793          	li	a5,120
    7c20:	02f71463          	bne	a4,a5,7c48 <vprintf+0x11e>
        printint(fd, va_arg(ap, int), 16, 0);
    7c24:	fb843783          	ld	a5,-72(s0)
    7c28:	00878713          	addi	a4,a5,8
    7c2c:	fae43c23          	sd	a4,-72(s0)
    7c30:	4398                	lw	a4,0(a5)
    7c32:	fcc42783          	lw	a5,-52(s0)
    7c36:	4681                	li	a3,0
    7c38:	4641                	li	a2,16
    7c3a:	85ba                	mv	a1,a4
    7c3c:	853e                	mv	a0,a5
    7c3e:	00000097          	auipc	ra,0x0
    7c42:	d58080e7          	jalr	-680(ra) # 7996 <printint>
    7c46:	aa39                	j	7d64 <vprintf+0x23a>
      } else if(c == 'p') {
    7c48:	fdc42783          	lw	a5,-36(s0)
    7c4c:	0007871b          	sext.w	a4,a5
    7c50:	07000793          	li	a5,112
    7c54:	02f71263          	bne	a4,a5,7c78 <vprintf+0x14e>
        printptr(fd, va_arg(ap, uint64));
    7c58:	fb843783          	ld	a5,-72(s0)
    7c5c:	00878713          	addi	a4,a5,8
    7c60:	fae43c23          	sd	a4,-72(s0)
    7c64:	6398                	ld	a4,0(a5)
    7c66:	fcc42783          	lw	a5,-52(s0)
    7c6a:	85ba                	mv	a1,a4
    7c6c:	853e                	mv	a0,a5
    7c6e:	00000097          	auipc	ra,0x0
    7c72:	e30080e7          	jalr	-464(ra) # 7a9e <printptr>
    7c76:	a0fd                	j	7d64 <vprintf+0x23a>
      } else if(c == 's'){
    7c78:	fdc42783          	lw	a5,-36(s0)
    7c7c:	0007871b          	sext.w	a4,a5
    7c80:	07300793          	li	a5,115
    7c84:	04f71c63          	bne	a4,a5,7cdc <vprintf+0x1b2>
        s = va_arg(ap, char*);
    7c88:	fb843783          	ld	a5,-72(s0)
    7c8c:	00878713          	addi	a4,a5,8
    7c90:	fae43c23          	sd	a4,-72(s0)
    7c94:	639c                	ld	a5,0(a5)
    7c96:	fef43423          	sd	a5,-24(s0)
        if(s == 0)
    7c9a:	fe843783          	ld	a5,-24(s0)
    7c9e:	eb8d                	bnez	a5,7cd0 <vprintf+0x1a6>
          s = "(null)";
    7ca0:	00003797          	auipc	a5,0x3
    7ca4:	95078793          	addi	a5,a5,-1712 # a5f0 <malloc+0x2616>
    7ca8:	fef43423          	sd	a5,-24(s0)
        while(*s != 0){
    7cac:	a015                	j	7cd0 <vprintf+0x1a6>
          putc(fd, *s);
    7cae:	fe843783          	ld	a5,-24(s0)
    7cb2:	0007c703          	lbu	a4,0(a5)
    7cb6:	fcc42783          	lw	a5,-52(s0)
    7cba:	85ba                	mv	a1,a4
    7cbc:	853e                	mv	a0,a5
    7cbe:	00000097          	auipc	ra,0x0
    7cc2:	ca2080e7          	jalr	-862(ra) # 7960 <putc>
          s++;
    7cc6:	fe843783          	ld	a5,-24(s0)
    7cca:	0785                	addi	a5,a5,1
    7ccc:	fef43423          	sd	a5,-24(s0)
        while(*s != 0){
    7cd0:	fe843783          	ld	a5,-24(s0)
    7cd4:	0007c783          	lbu	a5,0(a5)
    7cd8:	fbf9                	bnez	a5,7cae <vprintf+0x184>
    7cda:	a069                	j	7d64 <vprintf+0x23a>
        }
      } else if(c == 'c'){
    7cdc:	fdc42783          	lw	a5,-36(s0)
    7ce0:	0007871b          	sext.w	a4,a5
    7ce4:	06300793          	li	a5,99
    7ce8:	02f71463          	bne	a4,a5,7d10 <vprintf+0x1e6>
        putc(fd, va_arg(ap, uint));
    7cec:	fb843783          	ld	a5,-72(s0)
    7cf0:	00878713          	addi	a4,a5,8
    7cf4:	fae43c23          	sd	a4,-72(s0)
    7cf8:	439c                	lw	a5,0(a5)
    7cfa:	0ff7f713          	zext.b	a4,a5
    7cfe:	fcc42783          	lw	a5,-52(s0)
    7d02:	85ba                	mv	a1,a4
    7d04:	853e                	mv	a0,a5
    7d06:	00000097          	auipc	ra,0x0
    7d0a:	c5a080e7          	jalr	-934(ra) # 7960 <putc>
    7d0e:	a899                	j	7d64 <vprintf+0x23a>
      } else if(c == '%'){
    7d10:	fdc42783          	lw	a5,-36(s0)
    7d14:	0007871b          	sext.w	a4,a5
    7d18:	02500793          	li	a5,37
    7d1c:	00f71f63          	bne	a4,a5,7d3a <vprintf+0x210>
        putc(fd, c);
    7d20:	fdc42783          	lw	a5,-36(s0)
    7d24:	0ff7f713          	zext.b	a4,a5
    7d28:	fcc42783          	lw	a5,-52(s0)
    7d2c:	85ba                	mv	a1,a4
    7d2e:	853e                	mv	a0,a5
    7d30:	00000097          	auipc	ra,0x0
    7d34:	c30080e7          	jalr	-976(ra) # 7960 <putc>
    7d38:	a035                	j	7d64 <vprintf+0x23a>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    7d3a:	fcc42783          	lw	a5,-52(s0)
    7d3e:	02500593          	li	a1,37
    7d42:	853e                	mv	a0,a5
    7d44:	00000097          	auipc	ra,0x0
    7d48:	c1c080e7          	jalr	-996(ra) # 7960 <putc>
        putc(fd, c);
    7d4c:	fdc42783          	lw	a5,-36(s0)
    7d50:	0ff7f713          	zext.b	a4,a5
    7d54:	fcc42783          	lw	a5,-52(s0)
    7d58:	85ba                	mv	a1,a4
    7d5a:	853e                	mv	a0,a5
    7d5c:	00000097          	auipc	ra,0x0
    7d60:	c04080e7          	jalr	-1020(ra) # 7960 <putc>
      }
      state = 0;
    7d64:	fe042023          	sw	zero,-32(s0)
  for(i = 0; fmt[i]; i++){
    7d68:	fe442783          	lw	a5,-28(s0)
    7d6c:	2785                	addiw	a5,a5,1
    7d6e:	fef42223          	sw	a5,-28(s0)
    7d72:	fe442783          	lw	a5,-28(s0)
    7d76:	fc043703          	ld	a4,-64(s0)
    7d7a:	97ba                	add	a5,a5,a4
    7d7c:	0007c783          	lbu	a5,0(a5)
    7d80:	dc0795e3          	bnez	a5,7b4a <vprintf+0x20>
    }
  }
}
    7d84:	0001                	nop
    7d86:	0001                	nop
    7d88:	60a6                	ld	ra,72(sp)
    7d8a:	6406                	ld	s0,64(sp)
    7d8c:	6161                	addi	sp,sp,80
    7d8e:	8082                	ret

0000000000007d90 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    7d90:	7159                	addi	sp,sp,-112
    7d92:	fc06                	sd	ra,56(sp)
    7d94:	f822                	sd	s0,48(sp)
    7d96:	0080                	addi	s0,sp,64
    7d98:	fcb43823          	sd	a1,-48(s0)
    7d9c:	e010                	sd	a2,0(s0)
    7d9e:	e414                	sd	a3,8(s0)
    7da0:	e818                	sd	a4,16(s0)
    7da2:	ec1c                	sd	a5,24(s0)
    7da4:	03043023          	sd	a6,32(s0)
    7da8:	03143423          	sd	a7,40(s0)
    7dac:	87aa                	mv	a5,a0
    7dae:	fcf42e23          	sw	a5,-36(s0)
  va_list ap;

  va_start(ap, fmt);
    7db2:	03040793          	addi	a5,s0,48
    7db6:	fcf43423          	sd	a5,-56(s0)
    7dba:	fc843783          	ld	a5,-56(s0)
    7dbe:	fd078793          	addi	a5,a5,-48
    7dc2:	fef43423          	sd	a5,-24(s0)
  vprintf(fd, fmt, ap);
    7dc6:	fe843703          	ld	a4,-24(s0)
    7dca:	fdc42783          	lw	a5,-36(s0)
    7dce:	863a                	mv	a2,a4
    7dd0:	fd043583          	ld	a1,-48(s0)
    7dd4:	853e                	mv	a0,a5
    7dd6:	00000097          	auipc	ra,0x0
    7dda:	d54080e7          	jalr	-684(ra) # 7b2a <vprintf>
}
    7dde:	0001                	nop
    7de0:	70e2                	ld	ra,56(sp)
    7de2:	7442                	ld	s0,48(sp)
    7de4:	6165                	addi	sp,sp,112
    7de6:	8082                	ret

0000000000007de8 <printf>:

void
printf(const char *fmt, ...)
{
    7de8:	7159                	addi	sp,sp,-112
    7dea:	f406                	sd	ra,40(sp)
    7dec:	f022                	sd	s0,32(sp)
    7dee:	1800                	addi	s0,sp,48
    7df0:	fca43c23          	sd	a0,-40(s0)
    7df4:	e40c                	sd	a1,8(s0)
    7df6:	e810                	sd	a2,16(s0)
    7df8:	ec14                	sd	a3,24(s0)
    7dfa:	f018                	sd	a4,32(s0)
    7dfc:	f41c                	sd	a5,40(s0)
    7dfe:	03043823          	sd	a6,48(s0)
    7e02:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    7e06:	04040793          	addi	a5,s0,64
    7e0a:	fcf43823          	sd	a5,-48(s0)
    7e0e:	fd043783          	ld	a5,-48(s0)
    7e12:	fc878793          	addi	a5,a5,-56
    7e16:	fef43423          	sd	a5,-24(s0)
  vprintf(1, fmt, ap);
    7e1a:	fe843783          	ld	a5,-24(s0)
    7e1e:	863e                	mv	a2,a5
    7e20:	fd843583          	ld	a1,-40(s0)
    7e24:	4505                	li	a0,1
    7e26:	00000097          	auipc	ra,0x0
    7e2a:	d04080e7          	jalr	-764(ra) # 7b2a <vprintf>
}
    7e2e:	0001                	nop
    7e30:	70a2                	ld	ra,40(sp)
    7e32:	7402                	ld	s0,32(sp)
    7e34:	6165                	addi	sp,sp,112
    7e36:	8082                	ret

0000000000007e38 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    7e38:	7179                	addi	sp,sp,-48
    7e3a:	f422                	sd	s0,40(sp)
    7e3c:	1800                	addi	s0,sp,48
    7e3e:	fca43c23          	sd	a0,-40(s0)
  Header *bp, *p;

  bp = (Header*)ap - 1;
    7e42:	fd843783          	ld	a5,-40(s0)
    7e46:	17c1                	addi	a5,a5,-16
    7e48:	fef43023          	sd	a5,-32(s0)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    7e4c:	0000a797          	auipc	a5,0xa
    7e50:	e4c78793          	addi	a5,a5,-436 # 11c98 <freep>
    7e54:	639c                	ld	a5,0(a5)
    7e56:	fef43423          	sd	a5,-24(s0)
    7e5a:	a815                	j	7e8e <free+0x56>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    7e5c:	fe843783          	ld	a5,-24(s0)
    7e60:	639c                	ld	a5,0(a5)
    7e62:	fe843703          	ld	a4,-24(s0)
    7e66:	00f76f63          	bltu	a4,a5,7e84 <free+0x4c>
    7e6a:	fe043703          	ld	a4,-32(s0)
    7e6e:	fe843783          	ld	a5,-24(s0)
    7e72:	02e7eb63          	bltu	a5,a4,7ea8 <free+0x70>
    7e76:	fe843783          	ld	a5,-24(s0)
    7e7a:	639c                	ld	a5,0(a5)
    7e7c:	fe043703          	ld	a4,-32(s0)
    7e80:	02f76463          	bltu	a4,a5,7ea8 <free+0x70>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    7e84:	fe843783          	ld	a5,-24(s0)
    7e88:	639c                	ld	a5,0(a5)
    7e8a:	fef43423          	sd	a5,-24(s0)
    7e8e:	fe043703          	ld	a4,-32(s0)
    7e92:	fe843783          	ld	a5,-24(s0)
    7e96:	fce7f3e3          	bgeu	a5,a4,7e5c <free+0x24>
    7e9a:	fe843783          	ld	a5,-24(s0)
    7e9e:	639c                	ld	a5,0(a5)
    7ea0:	fe043703          	ld	a4,-32(s0)
    7ea4:	faf77ce3          	bgeu	a4,a5,7e5c <free+0x24>
      break;
  if(bp + bp->s.size == p->s.ptr){
    7ea8:	fe043783          	ld	a5,-32(s0)
    7eac:	479c                	lw	a5,8(a5)
    7eae:	1782                	slli	a5,a5,0x20
    7eb0:	9381                	srli	a5,a5,0x20
    7eb2:	0792                	slli	a5,a5,0x4
    7eb4:	fe043703          	ld	a4,-32(s0)
    7eb8:	973e                	add	a4,a4,a5
    7eba:	fe843783          	ld	a5,-24(s0)
    7ebe:	639c                	ld	a5,0(a5)
    7ec0:	02f71763          	bne	a4,a5,7eee <free+0xb6>
    bp->s.size += p->s.ptr->s.size;
    7ec4:	fe043783          	ld	a5,-32(s0)
    7ec8:	4798                	lw	a4,8(a5)
    7eca:	fe843783          	ld	a5,-24(s0)
    7ece:	639c                	ld	a5,0(a5)
    7ed0:	479c                	lw	a5,8(a5)
    7ed2:	9fb9                	addw	a5,a5,a4
    7ed4:	0007871b          	sext.w	a4,a5
    7ed8:	fe043783          	ld	a5,-32(s0)
    7edc:	c798                	sw	a4,8(a5)
    bp->s.ptr = p->s.ptr->s.ptr;
    7ede:	fe843783          	ld	a5,-24(s0)
    7ee2:	639c                	ld	a5,0(a5)
    7ee4:	6398                	ld	a4,0(a5)
    7ee6:	fe043783          	ld	a5,-32(s0)
    7eea:	e398                	sd	a4,0(a5)
    7eec:	a039                	j	7efa <free+0xc2>
  } else
    bp->s.ptr = p->s.ptr;
    7eee:	fe843783          	ld	a5,-24(s0)
    7ef2:	6398                	ld	a4,0(a5)
    7ef4:	fe043783          	ld	a5,-32(s0)
    7ef8:	e398                	sd	a4,0(a5)
  if(p + p->s.size == bp){
    7efa:	fe843783          	ld	a5,-24(s0)
    7efe:	479c                	lw	a5,8(a5)
    7f00:	1782                	slli	a5,a5,0x20
    7f02:	9381                	srli	a5,a5,0x20
    7f04:	0792                	slli	a5,a5,0x4
    7f06:	fe843703          	ld	a4,-24(s0)
    7f0a:	97ba                	add	a5,a5,a4
    7f0c:	fe043703          	ld	a4,-32(s0)
    7f10:	02f71563          	bne	a4,a5,7f3a <free+0x102>
    p->s.size += bp->s.size;
    7f14:	fe843783          	ld	a5,-24(s0)
    7f18:	4798                	lw	a4,8(a5)
    7f1a:	fe043783          	ld	a5,-32(s0)
    7f1e:	479c                	lw	a5,8(a5)
    7f20:	9fb9                	addw	a5,a5,a4
    7f22:	0007871b          	sext.w	a4,a5
    7f26:	fe843783          	ld	a5,-24(s0)
    7f2a:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    7f2c:	fe043783          	ld	a5,-32(s0)
    7f30:	6398                	ld	a4,0(a5)
    7f32:	fe843783          	ld	a5,-24(s0)
    7f36:	e398                	sd	a4,0(a5)
    7f38:	a031                	j	7f44 <free+0x10c>
  } else
    p->s.ptr = bp;
    7f3a:	fe843783          	ld	a5,-24(s0)
    7f3e:	fe043703          	ld	a4,-32(s0)
    7f42:	e398                	sd	a4,0(a5)
  freep = p;
    7f44:	0000a797          	auipc	a5,0xa
    7f48:	d5478793          	addi	a5,a5,-684 # 11c98 <freep>
    7f4c:	fe843703          	ld	a4,-24(s0)
    7f50:	e398                	sd	a4,0(a5)
}
    7f52:	0001                	nop
    7f54:	7422                	ld	s0,40(sp)
    7f56:	6145                	addi	sp,sp,48
    7f58:	8082                	ret

0000000000007f5a <morecore>:

static Header*
morecore(uint nu)
{
    7f5a:	7179                	addi	sp,sp,-48
    7f5c:	f406                	sd	ra,40(sp)
    7f5e:	f022                	sd	s0,32(sp)
    7f60:	1800                	addi	s0,sp,48
    7f62:	87aa                	mv	a5,a0
    7f64:	fcf42e23          	sw	a5,-36(s0)
  char *p;
  Header *hp;

  if(nu < 4096)
    7f68:	fdc42783          	lw	a5,-36(s0)
    7f6c:	0007871b          	sext.w	a4,a5
    7f70:	6785                	lui	a5,0x1
    7f72:	00f77563          	bgeu	a4,a5,7f7c <morecore+0x22>
    nu = 4096;
    7f76:	6785                	lui	a5,0x1
    7f78:	fcf42e23          	sw	a5,-36(s0)
  p = sbrk(nu * sizeof(Header));
    7f7c:	fdc42783          	lw	a5,-36(s0)
    7f80:	0047979b          	slliw	a5,a5,0x4
    7f84:	2781                	sext.w	a5,a5
    7f86:	2781                	sext.w	a5,a5
    7f88:	853e                	mv	a0,a5
    7f8a:	00000097          	auipc	ra,0x0
    7f8e:	9ae080e7          	jalr	-1618(ra) # 7938 <sbrk>
    7f92:	fea43423          	sd	a0,-24(s0)
  if(p == (char*)-1)
    7f96:	fe843703          	ld	a4,-24(s0)
    7f9a:	57fd                	li	a5,-1
    7f9c:	00f71463          	bne	a4,a5,7fa4 <morecore+0x4a>
    return 0;
    7fa0:	4781                	li	a5,0
    7fa2:	a03d                	j	7fd0 <morecore+0x76>
  hp = (Header*)p;
    7fa4:	fe843783          	ld	a5,-24(s0)
    7fa8:	fef43023          	sd	a5,-32(s0)
  hp->s.size = nu;
    7fac:	fe043783          	ld	a5,-32(s0)
    7fb0:	fdc42703          	lw	a4,-36(s0)
    7fb4:	c798                	sw	a4,8(a5)
  free((void*)(hp + 1));
    7fb6:	fe043783          	ld	a5,-32(s0)
    7fba:	07c1                	addi	a5,a5,16 # 1010 <truncate3+0x1c2>
    7fbc:	853e                	mv	a0,a5
    7fbe:	00000097          	auipc	ra,0x0
    7fc2:	e7a080e7          	jalr	-390(ra) # 7e38 <free>
  return freep;
    7fc6:	0000a797          	auipc	a5,0xa
    7fca:	cd278793          	addi	a5,a5,-814 # 11c98 <freep>
    7fce:	639c                	ld	a5,0(a5)
}
    7fd0:	853e                	mv	a0,a5
    7fd2:	70a2                	ld	ra,40(sp)
    7fd4:	7402                	ld	s0,32(sp)
    7fd6:	6145                	addi	sp,sp,48
    7fd8:	8082                	ret

0000000000007fda <malloc>:

void*
malloc(uint nbytes)
{
    7fda:	7139                	addi	sp,sp,-64
    7fdc:	fc06                	sd	ra,56(sp)
    7fde:	f822                	sd	s0,48(sp)
    7fe0:	0080                	addi	s0,sp,64
    7fe2:	87aa                	mv	a5,a0
    7fe4:	fcf42623          	sw	a5,-52(s0)
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    7fe8:	fcc46783          	lwu	a5,-52(s0)
    7fec:	07bd                	addi	a5,a5,15
    7fee:	8391                	srli	a5,a5,0x4
    7ff0:	2781                	sext.w	a5,a5
    7ff2:	2785                	addiw	a5,a5,1
    7ff4:	fcf42e23          	sw	a5,-36(s0)
  if((prevp = freep) == 0){
    7ff8:	0000a797          	auipc	a5,0xa
    7ffc:	ca078793          	addi	a5,a5,-864 # 11c98 <freep>
    8000:	639c                	ld	a5,0(a5)
    8002:	fef43023          	sd	a5,-32(s0)
    8006:	fe043783          	ld	a5,-32(s0)
    800a:	ef95                	bnez	a5,8046 <malloc+0x6c>
    base.s.ptr = freep = prevp = &base;
    800c:	0000a797          	auipc	a5,0xa
    8010:	c7c78793          	addi	a5,a5,-900 # 11c88 <base>
    8014:	fef43023          	sd	a5,-32(s0)
    8018:	0000a797          	auipc	a5,0xa
    801c:	c8078793          	addi	a5,a5,-896 # 11c98 <freep>
    8020:	fe043703          	ld	a4,-32(s0)
    8024:	e398                	sd	a4,0(a5)
    8026:	0000a797          	auipc	a5,0xa
    802a:	c7278793          	addi	a5,a5,-910 # 11c98 <freep>
    802e:	6398                	ld	a4,0(a5)
    8030:	0000a797          	auipc	a5,0xa
    8034:	c5878793          	addi	a5,a5,-936 # 11c88 <base>
    8038:	e398                	sd	a4,0(a5)
    base.s.size = 0;
    803a:	0000a797          	auipc	a5,0xa
    803e:	c4e78793          	addi	a5,a5,-946 # 11c88 <base>
    8042:	0007a423          	sw	zero,8(a5)
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    8046:	fe043783          	ld	a5,-32(s0)
    804a:	639c                	ld	a5,0(a5)
    804c:	fef43423          	sd	a5,-24(s0)
    if(p->s.size >= nunits){
    8050:	fe843783          	ld	a5,-24(s0)
    8054:	4798                	lw	a4,8(a5)
    8056:	fdc42783          	lw	a5,-36(s0)
    805a:	2781                	sext.w	a5,a5
    805c:	06f76763          	bltu	a4,a5,80ca <malloc+0xf0>
      if(p->s.size == nunits)
    8060:	fe843783          	ld	a5,-24(s0)
    8064:	4798                	lw	a4,8(a5)
    8066:	fdc42783          	lw	a5,-36(s0)
    806a:	2781                	sext.w	a5,a5
    806c:	00e79963          	bne	a5,a4,807e <malloc+0xa4>
        prevp->s.ptr = p->s.ptr;
    8070:	fe843783          	ld	a5,-24(s0)
    8074:	6398                	ld	a4,0(a5)
    8076:	fe043783          	ld	a5,-32(s0)
    807a:	e398                	sd	a4,0(a5)
    807c:	a825                	j	80b4 <malloc+0xda>
      else {
        p->s.size -= nunits;
    807e:	fe843783          	ld	a5,-24(s0)
    8082:	479c                	lw	a5,8(a5)
    8084:	fdc42703          	lw	a4,-36(s0)
    8088:	9f99                	subw	a5,a5,a4
    808a:	0007871b          	sext.w	a4,a5
    808e:	fe843783          	ld	a5,-24(s0)
    8092:	c798                	sw	a4,8(a5)
        p += p->s.size;
    8094:	fe843783          	ld	a5,-24(s0)
    8098:	479c                	lw	a5,8(a5)
    809a:	1782                	slli	a5,a5,0x20
    809c:	9381                	srli	a5,a5,0x20
    809e:	0792                	slli	a5,a5,0x4
    80a0:	fe843703          	ld	a4,-24(s0)
    80a4:	97ba                	add	a5,a5,a4
    80a6:	fef43423          	sd	a5,-24(s0)
        p->s.size = nunits;
    80aa:	fe843783          	ld	a5,-24(s0)
    80ae:	fdc42703          	lw	a4,-36(s0)
    80b2:	c798                	sw	a4,8(a5)
      }
      freep = prevp;
    80b4:	0000a797          	auipc	a5,0xa
    80b8:	be478793          	addi	a5,a5,-1052 # 11c98 <freep>
    80bc:	fe043703          	ld	a4,-32(s0)
    80c0:	e398                	sd	a4,0(a5)
      return (void*)(p + 1);
    80c2:	fe843783          	ld	a5,-24(s0)
    80c6:	07c1                	addi	a5,a5,16
    80c8:	a091                	j	810c <malloc+0x132>
    }
    if(p == freep)
    80ca:	0000a797          	auipc	a5,0xa
    80ce:	bce78793          	addi	a5,a5,-1074 # 11c98 <freep>
    80d2:	639c                	ld	a5,0(a5)
    80d4:	fe843703          	ld	a4,-24(s0)
    80d8:	02f71063          	bne	a4,a5,80f8 <malloc+0x11e>
      if((p = morecore(nunits)) == 0)
    80dc:	fdc42783          	lw	a5,-36(s0)
    80e0:	853e                	mv	a0,a5
    80e2:	00000097          	auipc	ra,0x0
    80e6:	e78080e7          	jalr	-392(ra) # 7f5a <morecore>
    80ea:	fea43423          	sd	a0,-24(s0)
    80ee:	fe843783          	ld	a5,-24(s0)
    80f2:	e399                	bnez	a5,80f8 <malloc+0x11e>
        return 0;
    80f4:	4781                	li	a5,0
    80f6:	a819                	j	810c <malloc+0x132>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    80f8:	fe843783          	ld	a5,-24(s0)
    80fc:	fef43023          	sd	a5,-32(s0)
    8100:	fe843783          	ld	a5,-24(s0)
    8104:	639c                	ld	a5,0(a5)
    8106:	fef43423          	sd	a5,-24(s0)
    if(p->s.size >= nunits){
    810a:	b799                	j	8050 <malloc+0x76>
  }
}
    810c:	853e                	mv	a0,a5
    810e:	70e2                	ld	ra,56(sp)
    8110:	7442                	ld	s0,48(sp)
    8112:	6121                	addi	sp,sp,64
    8114:	8082                	ret
